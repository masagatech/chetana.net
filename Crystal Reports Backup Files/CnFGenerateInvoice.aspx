<%@ Page Title="CnF Generate Invoice" Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="CnFGenerateInvoice.aspx.cs" Inherits="CnFGenerateInvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="section-header">
        <div class="title">
            ...
            CnF Generate Invoice <a href="Campaigns.aspx" title="back to campaign list"></a>
        </div>
                                    ...
                                    <ContentTemplate>
                                        <table style="float: right;" cellspacing="2" cellpadding="2">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="2">
                                                    <asp:Button ID="Button1" Visible="false" CommandArgument='<%#Eval("SubConfirmID")%>' OnClick="btnPrint_Click"
    ...
    <script type="text/javascript">
        function setVal(id, orgdocno) {
            ...
            document.getElementById("ctl00_ContentPlaceHolder1_txtOrgDocNo").value = orgdocno;
