<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintDCPending.aspx.cs" Inherits="Print_PrintDC" %>
...
<head runat="server">
    <title>Print DC</title>
</head>
<body>
    <form id="form1" runat="server">
    <div>
     <CR:CrystalReportViewer ID="PrintDC" runat="server" AutoDataBind="true"
