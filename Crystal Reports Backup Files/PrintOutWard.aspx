<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintOutWard.aspx.cs" Inherits="Print_PrintOutWard" %>
...
<head runat="server">
    <title>Print OutWard</title>
</head>
<body>
    <form id="form1" runat="server">
    <div>
        <CR:CrystalReportViewer ID="Printoutward" runat="server" AutoDataBind="true"
