<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddBookMaster.ascx.cs"
    Inherits="UserControls_AddBookMaster" %>
    ...
    <asp:Panel ID="Panel1" CssClass="panelDetails" runat="server" Width="480px">
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtqty" MaxLength="10" CssClass="inp-form" TabIndex="12" runat="server">0</asp:TextBox>
            ...
            <tr>
                <td>
                    <asp:CheckBox ID="chekIsactive" TabIndex="13" runat="server" Text="Block" Checked="false" />
                </td>
            </tr>
        </table>
        <hr runat="server" />
        <asp:Label ID="Label17" CssClass="lbl-form" runat="server" Text="Re-Order Level" style="font-weight:bold" ></asp:Label> 
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td width="95px">
                    <asp:Label ID="Label15" CssClass="lbl-form" runat="server" Text="Physical Stock"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtphystock" MaxLength="10" CssClass="inp-form" TabIndex="12" runat="server">0</asp:TextBox>
                    <ajaxCt:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txtphystock"
                        FilterType="Custom, Numbers" />
                </td>
                <td>
                </td>
                <td width="95px">
                    <asp:Label ID="Label16" CssClass="lbl-form" runat="server" Text="Virtual Stock"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtvirtualStock" MaxLength="10" CssClass="inp-form" TabIndex="12"
                        runat="server">0</asp:TextBox>
                    <ajaxCt:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" TargetControlID="txtvirtualStock"
                        FilterType="Custom, Numbers" />
                </td>
            </tr>
        </table>
   ...
   document.getElementById('status').innerHTML=status;
    ...
    <asp:Panel ID="pnlBookDetails" runat="server">
        ...
        <asp:GridView ID="grdBookDetails" AllowPaging="true" AutoGenerateColumns="false"
            CellPadding="4" CssClass="product-table" ForeColor="#333333" PageSize="500" runat="server"
            AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="grdBookDetails_PageIndexChanging"
            OnRowDeleting="grdBookDetails_RowDeleting" OnRowEditing="grdBookDetails_RowEditing"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="OI.Price" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lblphystk" runat="server" Style="display: none;" Text='<%#Eval("Phystk")%>'></asp:Label>
                        <asp:Label ID="lblvirtstk" runat="server" Style="display: none;" Text='<%#Eval("Virtstk")%>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="IsBlock" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:CheckBox ID="chkIsActive" runat="server" Checked='<%#Eval("IsActive") %>' Enabled="false" style="display:none;"> </asp:CheckBox>
                         <asp:CheckBox ID="chkIsBlock" runat="server" Checked='<%#Eval("IsBlock") %>' Enabled="false">
                        </asp:CheckBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Action" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="center"
                    ...
                    <ItemTemplate>
                        ...
                        <asp:ImageButton ID="lblDelete" runat="server" CausesValidation="false" CommandName="Delete"
                            CssClass="close" ToolTip="Remove" ImageUrl="../Images/icon/DeleteIcon.gif" OnClientClick="return confirm('You really want to Delete?')" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
