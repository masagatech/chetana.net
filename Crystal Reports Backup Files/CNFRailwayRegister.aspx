            ...
            <tr>
                <td>
                    <asp:DropDownList CssClass="ddl-form" ID="DDLSuperZone" TabIndex="1" runat="server"
                        DataTextField="CnFName" DataValueField="cnfid" Width="200px">
                    </asp:DropDownList>
                    <asp:Label ID="lblMessage" runat="server" Style="color:red">*</asp:Label>
                    <asp:RequiredFieldValidator ID="DDLSuperZonevali" Style="display: none;" runat="server"
                        InitialValue="0" ErrorMessage="Kindly Select CnF from the list" ValidationGroup="v1"
                        ControlToValidate="DDLSuperZone">.</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
