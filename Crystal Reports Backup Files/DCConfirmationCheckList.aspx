<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="DCConfirmationCheckList.aspx.cs" Inherits="DCConfirmationCheckList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
        <div class="section-header">
            <div class="title">
                ...
                DC Confirmation CheckList <a href="Campaigns.aspx" title="back to campaign list"></a>
            </div>
            <div class="options">
            </div>
    ...
    <input name="filt" onkeyup="filter(this, 'sf', '<%=grdDetails.ClientID%>')" id="filterdata"
        ...
        <br />
        <br />
        <CR:CrystalReportViewer ID="confirmchecklist" runat="server" AutoDataBind="true"
