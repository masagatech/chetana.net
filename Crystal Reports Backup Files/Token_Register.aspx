<%@ Page Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true"
    CodeFile="Token_Register.aspx.cs" Inherits="Token_Register" Title="Token Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="title">
       ...
       Add Token Register<a href="Campaigns.aspx" title="back to campaign list"></a>
    </div>
                ...
                <tr>
                    <td>
                        ...
                        <asp:Panel ID="TokenWise" runat="server">
                            ...
                            <asp:TextBox ID="txtTokenFind" CssClass="TextBoxWodth" runat="server"></asp:TextBox>
                        ...
                        <asp:Panel ID="KycNoWise" runat="server" Visible="false">
                            ...
                            <asp:TextBox ID="txtKycFind" CssClass="TextBoxWodth" runat="server"></asp:TextBox>
                            ...
                            <asp:Button ID="kycbtnGet" runat="server" CssClass="submitbtn" Text="Get" Width="53px"
                ...
                <table style="width: 100%;">
                    <tr>
                     <td style="padding-top: 18px">
                        ...
                        <td style="padding-top: 6px; width: 7%">
