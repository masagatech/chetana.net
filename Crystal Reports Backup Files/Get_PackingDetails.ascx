<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Get_PackingDetails.ascx.cs" Inherits="Godown_Get_PackingDetails" %>
    ...
    <table cellpadding="5" cellspacing="5">
        <tr>
            <td align="left" valign="top">
                <asp:RadioButtonList Visible="false" CellPadding="2" CellSpacing="2" ID="rdoview" runat="server"
