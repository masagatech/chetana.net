<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="CheckListReport.aspx.cs" Inherits="CheckListReport" %>
...
<div>
        <div class="section-header">
            <div class="title">
                ...
                CheckList Report <a href="Campaigns.aspx" title="back to campaign list"></a>
            </div>
            <div class="options">
            </div>
    ...
    <input name="filt" onkeyup="filter(this, 'sf', '<%=grdDetails.ClientID%>')" id="filterdata"
        ...
        <CR:CrystalReportViewer ID="Checklistrpt" runat="server" AutoDataBind="true" 
