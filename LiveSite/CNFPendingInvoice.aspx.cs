...
public partial class CNFPendingInvoice : System.Web.UI.Page
{
    ...
    protected void RepDetailsConfirm_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        try
        {
            ...
            if (Session["saved"].ToString() != e.CommandArgument.ToString().Trim())
            {
                ...
                {
                    bool Auth = ObjDal.Get_DocumentNum_Authentication(Convert.ToInt32(txtDocno.Text), Convert.ToInt32(strFY));
                    if (Auth)
                    {
                    ...
                    else
                    {
                        ...
                        foreach (GridViewRow row in objgrid.Rows)
                        {
                           ...
                           // _objactualinvoice.CnFFlag = true;
                       ...
                       // _objDCMaster.DocNo = Convert.ToInt32(txtDocno.Text);
                        ...
                        {
                            Rptrpending.DataSource = ObjDal.C_GetPendingApprovedDocNo(Convert.ToInt32(strFY), DDLCnfInvoice.SelectedValue.ToString());
    ...
    #endregion Get button Click Event
