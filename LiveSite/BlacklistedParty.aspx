<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="BlacklistedParty.aspx.cs" Inherits="BlacklistedParty" %>
    ...
    <div class="section-header">
        <div class="title">
            <div style="float: right; width: 101%">
                ...
                BlacklistedParty Report<a href="Campaigns.aspx" title="back to campaign list"></a>
            </div>
        </div>
    </div>
    <div>
        ...
        <asp:Panel ID="pnlcust" runat="server" CssClass="panelDetails" Width="700px" Height="90px">
            ...
            <tr>
                    <td class="style1">
                        <asp:Label ID="Label2" runat="server" CssClass="lbl-form" Text="S.D. Zone"></asp:Label>
                        <font color="red">*</font>
                    </td>
                    <td>
                        <asp:DropDownList ID="DDLSDZone" runat="server" AutoPostBack="true" CssClass="ddl-form"
                            DataTextField="SDZoneName" DataValueField="SDZoneId" OnSelectedIndexChanged="DDLSDZone_SelectedIndexChanged"
                            Width="200px">
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlSDZone"
                            ErrorMessage="Please select SuperZone" InitialValue="0" ValidationGroup="AZone123">.</asp:RequiredFieldValidator>
                    </td>
                </tr>
            <tr>
            <td>
