        ...
        //{
            ...
            //{
              ...
              //0, 0, 0, "scheme", Convert.ToInt32(DDLScheme.SelectedValue.ToString()), Convert.ToString(DDLCC.SelectedValue));
                ds= Other_Z.OtherBAL.Report_scheme(0,"", "", Convert.ToInt32(strFY),
                0, Convert.ToInt32(DDLSuperZone.SelectedValue.ToString()), Convert.ToInt32(DDLZone.SelectedValue.ToString()), "scheme", Convert.ToInt32(DDLScheme.SelectedValue.ToString()), "");
