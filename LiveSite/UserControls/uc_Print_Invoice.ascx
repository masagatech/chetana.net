<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_Print_Invoice.ascx.cs"
    Inherits="UserControls_ODC_uc_Print_Invoice" %>
...
<table width="90%">
    <tr>
        <td width="70%">
          ...
          <asp:ValidationSummary ID="ss"  ShowMessageBox="true" ShowSummary ="false" runat="server" ValidationGroup="DDlcust" />
                    ...
                    <ContentTemplate>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnDate" runat="server" Text="Get" TabIndex="3" CssClass="submitbtn" ValidationGroup="DDlDelDate"
                                        Width="50px" OnClick="btnDate_Click" />
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
            ...
            <asp:ValidationSummary ID="ss1"  ShowMessageBox="true" ShowSummary ="false" runat="server" ValidationGroup="DDlDelDate" />
            <br />
  ...
  <asp:Button ID="btnWithoutDisc" CommandArgument='<%#Eval("SubConfirmID")%>'   OnClick="btnWithoutDisc_Click"
                                    ...
                                    <asp:GridView ID="grdapproval" AlternatingRowStyle-CssClass="alt" CssClass="product-table"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Book Name" HeaderStyle-Width="150px">
                                                <ItemTemplate>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Bundles" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="right"
                                                HeaderStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Right">
                                                <ItemTemplate>
                                                    
                                                    <asp:Label ID="lblBundles" Style="text-align: right;" runat="server" Text='<%#Eval("Bundles")%>'
                                                        ToolTip="show details"></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblTotalBundles" runat="server" Text=""></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
