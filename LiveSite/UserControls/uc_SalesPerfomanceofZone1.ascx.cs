...
{
    #region Variables
    static int Active, twenty, twentyfive, thirty, thirtyfive, forty, zero;
    ...
    protected void grdoutstanding_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        {   // lblname
            ...
            grdcustomer.DataSource = Other.Dashboard.Get_Report_SalesPerformance_OnCustomer(Convert.ToInt32(zoneid), Convert.ToInt32(strFY), fdate, tdate).Tables[0];
            grdcustomer.DataBind();
            grdcustomer.Focus();
         ...
         //   grdzonedetail.DataBind();
            ...
            GrdBookset.DataSource = Other.Dashboard.Get_Report_SalesPerformanceForBookSet(Convert.ToInt32(zoneid), Convert.ToInt32(strFY), fdate, tdate);
            GrdBookset.DataBind();
