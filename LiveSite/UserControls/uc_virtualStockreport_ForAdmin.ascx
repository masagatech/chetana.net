<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_virtualStockreport_ForAdmin.ascx.cs" Inherits="UserControls_uc_virtualStockreport_ForAdmin" %>
...
<div style="float: right; width: 8%">
    <asp:Button ID="btnExport" CssClass="submitbtn" runat="server" Text="Export" Width="80px"
        TabIndex="3" Visible="false" OnClick="btnExport_Click" Style="height: 26px" />
</div>
<br />
<br />
<br />
