<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_State.ascx.cs" Inherits="UserControls_uc_Sate" %>
...
<asp:Panel ID="PnlStateDetails" runat="server">
    <asp:GridView ID="GrdStateDetails" runat="server" AllowPaging="false" AutoGenerateColumns="false"
        CellPadding="4" CssClass="product-table" ForeColor="#333333" AlternatingRowStyle-CssClass="alt"
        PageSize="10" Width="600px" onrowdeleting="GrdStateDetails_RowDeleting" 
        onrowediting="GrdStateDetails_RowEditing" >
        <Columns>
        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="State Code"
    ...
    <script type="text/javascript">
		                ...
		                var table = document.getElementById('<%=GrdStateDetails.ClientID%>');
 ...
 function setSatus()
   ...
   var status="[ Ctrl+F : Find ]";
    ...
    <asp:Panel ID="PnlAddState" CssClass="panelDetails" runat="server" Width="310px">
            <asp:Label ID="lblDmID"  runat="server" Text="0" style="display:none;"></asp:Label>
          <table cellpadding="0" cellspacing="0" style="width: 94%">
            <tr>
              <td >
                <asp:Label ID="Label1" CssClass="lbl-form" runat="server" Text="State Code"></asp:Label>
              </td>
              <td>
                <asp:TextBox ID="txtDmcode" TabIndex="1" CssClass="inp-form" runat="server" 
                      AutoPostBack="True" ontextchanged="txtDmcode_TextChanged" MaxLength="8"></asp:TextBox>
              </td>
              <td>
                <asp:RequiredFieldValidator ID="reqCode" runat="server" ErrorMessage="Require State Code" 
                    ValidationGroup="st1" ControlToValidate="txtDmcode">.</asp:RequiredFieldValidator>
             </td>
            </tr>
            <tr>
              <td >
                <asp:Label ID="Label2" CssClass="lbl-form" runat="server" Text="State Name"></asp:Label>
              </td>
              <td>
                <asp:TextBox ID="txtName" TabIndex="2" CssClass="inp-form" runat="server"></asp:TextBox>
              </td>
            <td>
                <asp:RequiredFieldValidator ID="reqName" runat="server" ErrorMessage="Require State Name" 
                    ValidationGroup="st1" ControlToValidate="txtName">.</asp:RequiredFieldValidator>
             </td>
            </tr>
            <tr>
              <td >
