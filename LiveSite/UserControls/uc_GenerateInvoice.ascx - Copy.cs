...
#endregion
public partial class UserControls_ODC_uc_GenerateInvoice : System.Web.UI.UserControl
{
...
//    decimal tamount = 0;
 ...
 string sHtml = "SMS Not Sent, Number Not Present";
    ...
    public delegate void EmailTask_Delegate(string s);
...
sendmail("Chetana Book Depot", EmailID, MailBodyDesign().ToString());
    ...
    public void SendEmail(string email)
    {
        ...
        //string ContatUsEmailID = ConfigurationManager.AppSettings["ContactUsEmail"];
        //string ConfirmEmailId = siteUrl;  
    ...
    public  void sendmail(string subject, string tomail, string body)
    {
        ...
        //mail.Bcc.Add(new MailAddress("parag@technople.com"));
        mail.Bcc.Add(new MailAddress("n.shah12@gmail.com"));
        // mail.Bcc.Add(new MailAddress("rupesh@technople.com"));
         mail.Bcc.Add(new MailAddress("chetanabookdepot1@gmail.com"));
        //mail.Bcc.Add(new MailAddress("technoplesolutions@gmail.com"));
        ...
        ////SmtpClient client = new SmtpClient("crm.chetanapublications.com");
        ////client.UseDefaultCredentials = false;
        //client.EnableSsl = Convert.ToBoolean(ConfigurationManager.AppSettings["Enablessl"].ToString());
        ////client.Credentials =new System.Net.NetworkCredential(ConfigurationManager.AppSettings["Username"].ToString(), ConfigurationManager.AppSettings["Password"].ToString());
        //client.Credentials = new System.Net.NetworkCredential("wecare@chetanapublications.com", "cbdcppl@2014");
        ...
        //mail.Subject = subject;
        ////string sSmtpServer = "";
        ////sSmtpServer = "crm.chetanapublications.com";
