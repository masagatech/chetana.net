<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_InquirySeverityMaster.ascx.cs" Inherits="UserControls_uc_InquirySeverityMaster" %>
...
<asp:Panel runat="server" ID="PnlISDetails" Width="100%">
        ...
        <Columns>
        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Inquiry Severity"
                HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <asp:Label ID="lblSeverityID" runat="server"  Style="display: none" Text='<%#Eval("SeverityID")%>'></asp:Label>                        
                    <asp:Label ID="lblSeverity_Name" runat="server"  Text='<%#Eval("Severity_Name") %>'></asp:Label>
                </ItemTemplate>             
            </asp:TemplateField>
    ...
    <asp:Panel ID="PnlISAdd" CssClass="panelDetails" runat="server" Width="310px">
           <asp:Label ID="lblSeverityID"  runat="server" Text="0" style="display:none;"></asp:Label>
        <table cellpadding="0" cellspacing="0" style="width: 94%">
            <tr>
              <td >
                <asp:Label ID="lblSeverityType" CssClass="lbl-form" runat="server" Text="Severity Type"></asp:Label>
              </td>
              <td>
                <asp:TextBox ID="txtSeverityType" TabIndex="1" CssClass="inp-form" runat="server" 
                        MaxLength="100" ontextchanged="txtSeverityType_TextChanged" Height="20px" Width="150px"></asp:TextBox>
              </td>
              <td>
                <asp:RequiredFieldValidator ID="reqCode" runat="server" ErrorMessage="Require Inquiry Status" 
                    ValidationGroup="st1" ControlToValidate="txtSeverityType">.</asp:RequiredFieldValidator>
             </td>
            </tr>
