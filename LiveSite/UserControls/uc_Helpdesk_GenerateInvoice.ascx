<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_Helpdesk_GenerateInvoice.ascx.cs"
...
<table width="90%">
    <tr>
        <td width="70%">
            ...
            <br />
            <asp:Panel ID="Panel2" Enabled="false" runat="server">
                                        ...
                                        <asp:TemplateField HeaderText="Rate" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="right"
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtrate" MaxLength="6" runat="server" onkeypress="return CheckNumericWithDot(event)"
                                                    Style="text-align: right;" Text='<%#Eval("Rate","{0:0.00}")%>' Width="45px" CssClass="TotalBox"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Discount" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="right"
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtdiscount" runat="server" MaxLength="6" Text='<%#Eval("Discount","{0:0.00}")%>'
                                                    Width="45px" HeaderStyle-HorizontalAlign="Left" Style="text-align: right;" onkeypress="return CheckNumericWithDot(event)"></asp:TextBox>
                                        ...
                                        <table style="float: right;" cellspacing="2" cellpadding="2">
                                            ...
                                            <tr>
                                                <td align="left" colspan="4">
                                                    <asp:Button ID="btnConfirmed" Visible="false" CommandArgument='<%#Eval("SubConfirmID")%>'
                                                        OnClick="btnapproval_Click" TabIndex="7" runat="server" Text="Create Invoice"
                                                        CssClass="submitbtn" Width="110px" Style="float: right;" OnClientClick="return confirm('Do you want to Create Invoice ?');" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4">
