...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
                ...
                <tr>
                    <td colspan="4">
                        <asp:RadioButtonList ID="RdbtnSelect" runat="server" RepeatDirection="Horizontal"
                            ...
                            <asp:ListItem Value="CustomerwiseCN"  Text="CustomerwiseCN"></asp:ListItem>
                            <asp:ListItem Value="GCN"  Text="GCN"></asp:ListItem>
                            <asp:ListItem Value="LR" Selected="True" Text="LR"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                </tr>
                <tr>
        ...
        <asp:Panel ID="Pnl3" CssClass="panelDetails" runat="server" Width="961px" ScrollBars="Vertical">
            <table>
                <tr>
                    <td>
                      <asp:TextBox ID="Txtgcnno" Height="15px" ToolTip="Return Qty" Width="100px"
                     CssClass="inp-form" runat="server"></asp:TextBox>
                <ajaxCt:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server" TargetControlID="Txtgcnno"
                    WatermarkText="Enter GCN No">
                </ajaxCt:TextBoxWatermarkExtender>
                    </td>
                    <td>
                    <asp:Button ID="btngcn" runat="server" Text="Get" CssClass="submitbtn" 
                            TabIndex="2" Width="50px" onclick="btngcn_Click"  />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        <br />
        <asp:Panel ID="Pnl4" CssClass="panelDetails" runat="server" Width="961px" ScrollBars="Vertical">
            <table>
                <tr>
                    <td>
                      <asp:TextBox ID="Txtlrnos" Height="15px" ToolTip="Return Qty" Width="100px"
                     CssClass="inp-form" runat="server"></asp:TextBox>
                <ajaxCt:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender2" runat="server" TargetControlID="Txtlrnos"
                    WatermarkText="Enter LR No">
                </ajaxCt:TextBoxWatermarkExtender>
                    </td>
                    <td>
                    <asp:Button ID="Btnno" runat="server" Text="Get" CssClass="submitbtn" 
                            TabIndex="2" Width="50px" onclick="Btnno_Click"  />
                    </td>
                </tr>
            </table>
        </asp:Panel>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <asp:TextBox ID="txRetqty" runat="server" AutoComplete="off" CssClass="inp-form"
                                MaxLength="6" onkeypress="return CheckNumeric(event)" Style="text-align: right;"
        ...
        <asp:Panel ID="PnlPrint" runat="server" Width="1200px">
            <%--<div class="actiontab">--%>
            ...
            <asp:GridView ID="grdcn" CssClass="product-table" AutoGenerateColumns="false" ShowFooter="true"
                runat="server" Width="1200px" CellPadding="2" 
                OnRowDataBound="grdcn_RowDataBound" onrowdeleted="grdcn_RowDeleted" 
               >
                <Columns>
