...
#endregion
public partial class UserControls_uc_virtualStockreport : System.Web.UI.UserControl
{
    string strFY;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            txtFromDate.Focus();
            //string 
           // Grdvirtualstockreport.DataSource = DCMaster.REP_Virtual_STOCK("", Convert.ToInt32(strFY));
            //Grdvirtualstockreport.DataBind();

            //lblTotalBooksInGodown.Text = DCMaster.REP_Virtual_STOCK("",Convert.ToInt32(strFY)).Tables[1].Rows[0][0].ToString();
