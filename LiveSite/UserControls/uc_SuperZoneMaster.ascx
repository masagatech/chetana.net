<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_SuperZoneMaster.ascx.cs"
    Inherits="UserControls_uc_SuperZoneMaster" %>
    ...
    <asp:GridView ID="grdSuperZoneDetails" runat="server" AllowPaging="true" AutoGenerateColumns="false"
        ...
        <Columns>
            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="SuperZone Code"
                ...
                <ItemTemplate>
                    <asp:Label ID="lblSZID" runat="server" Style="display: none" Text='<%#Eval("SuperZoneID")%>'></asp:Label>
                    <asp:Label ID="lblSZCode" runat="server" Text='<%#Eval("SuperZoneCode") %>'></asp:Label>
                </ItemTemplate>
           ...
           <asp:TemplateField HeaderText="Super Super Zone Name" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <asp:Label ID="lblSDZName" runat="server" Text='<%#Eval("SDZoneName")%>'></asp:Label>
                     <asp:Label ID="lblSdZoneId" runat="server" Text='<%#Eval("SDZoneId")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
          <asp:TemplateField HeaderText="Super Zone Email" HeaderStyle-BorderWidth="2px" >
                <ItemTemplate>
                    <asp:Label ID="lblsemail" runat="server" Text='<%#Eval("SEmailID")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
...
<asp:Panel ID="pnlSuperZone" CssClass="panelDetails" runat="server" Width="600px">
    <table width="70%" cellpadding="2" cellspacing="2">
        <tr>
            <td>
                <asp:Label ID="lblID" runat="server" Style="display: none;"></asp:Label>
                <asp:Label ID="Label1" CssClass="lbl-form" runat="server" Text="SuperZone Code"></asp:Label>
                <font color="red">*</font>
            </td>
            <td>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:TextBox ID="txtSZCode" width="200px" CssClass="inp-form" TabIndex="1" runat="server" AutoPostBack="True"
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" CssClass="lbl-form" runat="server" Text="SuperZone Name"></asp:Label>
                <font color="red">*</font>
            </td>
            <td>
                <asp:TextBox ID="txtSZName" CssClass="inp-form" TabIndex="2" runat="server"  width="200px"
                    MaxLength="50"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="ReqSZName" runat="server" ErrorMessage="Require SuperZone Name"
                    ValidationGroup="SuperZone" ControlToValidate="txtSZName">.</asp:RequiredFieldValidator>
            </td>
        </tr>
                <tr>
            <td>
                <asp:Label ID="Label4" CssClass="lbl-form" runat="server" Text="Super Duper Zone"></asp:Label>
            </td>
            <td>
                <asp:DropDownList  CssClass="ddl-form" ID="DDLSDZone" DataTextField="SDZoneName" 
                    DataValueField="SDZoneID"
                   width="200px" TabIndex="3" runat="server">
                </asp:DropDownList>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="ReqDDL" runat="server" ErrorMessage="Select Super Duper Zone"
                    InitialValue="none" ValidationGroup="zone" ControlToValidate="DDLSDZone">.</asp:RequiredFieldValidator>
            </td>
        </tr>
          <tr>
            <td>
                <asp:Label ID="Label5" CssClass="lbl-form" runat="server" Text="SuperZone Email"></asp:Label>
                <font color="red">*</font>
            </td>
            <td>
                <asp:TextBox ID="Txtsemail" CssClass="inp-form" TabIndex="4" runat="server"  width="200px"
                    MaxLength="50"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Require SuperZone Email"
                    ValidationGroup="SuperZone" ControlToValidate="Txtsemail">.</asp:RequiredFieldValidator>
            </td>
        </tr>
