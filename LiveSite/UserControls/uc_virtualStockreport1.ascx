<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_virtualStockreport.ascx.cs"
    Inherits="UserControls_uc_virtualStockreport" %>
<%@ Register TagPrefix="ajaxCt" Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" %>
<script src="js/ScrollableGrid.js" type="text/javascript"></script>
    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
        $('#<%=Grdvirtualstockreport.ClientID %>').Scrollable();
        }
)
</script>
<div class="section-header" style="display:block">
    <div class="title">
        ...
        <span runat="server" id="pageName"></span>Virtual Stock Report <a href="Campaigns.aspx"
...
<div style="float: left; width: 8%">
    <table>
        <tr>
            <td>
                <asp:Label ID="lblbkt" CssClass="lbl-form" Width ="100px" runat="server" Text="Book type"></asp:Label>
            </td>
            <td colspan="4">
            ...
            <td>
            <asp:Button ID="Btnget" CssClass="submitbtn" runat="server"  Text="Get" Width="80px" TabIndex ="2"
                    Style="height: 26px;display:none" onclick="Btnget_Click" />
...
<div style="float: right; width: 8%">
    <asp:Button ID="btnExport" CssClass="submitbtn" runat="server" Text="Export" Width="80px" TabIndex ="3"
...
<asp:Panel ID="pnldate" runat="server">
        <table>
            <tr>
                ...
                <asp:Button ID="btngetdate" TabIndex="3" CssClass="submitbtn" runat="server" Text="Get Data" 
                        Width="80px" ValidationGroup="date1" onclick="btngetdate_Click"
        />
                </td>
            </tr>
        </table>
    ...
    <asp:ValidationSummary ID="virtualstockSummary" runat ="server" ValidationGroup="date1" ShowMessageBox ="true"  ShowSummary="false" />
    <asp:GridView ID="Grdvirtualstockreport" runat="server" PageSize="2000" AlternatingRowStyle-CssClass="alt"
        ...
        <Columns>
            <asp:TemplateField HeaderStyle-Width="80px" HeaderStyle-BorderColor="Yellow" ItemStyle-BorderColor="Yellow" HeaderText="Book Code" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <asp:Label ID="lblbkcode" runat="server" Text='<%#Eval("BookCode")%>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle Width="80px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Book Name"  HeaderStyle-BorderColor="Aqua" ItemStyle-BorderColor="Aqua" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderStyle-Width="80px"  HeaderStyle-BorderColor="red" ItemStyle-BorderColor="Red" HeaderText="Opening Stock" ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderStyle-Width="80px" HeaderStyle-BorderColor="#800000" ItemStyle-BorderColor="#800000" HeaderText="Pur. Qty" ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
                    <asp:Label ID="lblReceived_Qty" runat="server" Style="text-align: right;" Text='<%#Eval("Received_Qty") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle Width="80px" />
            </asp:TemplateField>
             <asp:TemplateField HeaderStyle-Width="80px" HeaderStyle-BorderColor="#F87431" ItemStyle-BorderColor="#F87431" HeaderText="Rec. Qty" ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
                    <asp:Label ID="lblReceivedQty" runat="server" Style="text-align: right;" Text='<%#Eval("ReceivedQty") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle Width="80px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderStyle-Width="80px" HeaderStyle-BorderColor="Yellow" ItemStyle-BorderColor="Yellow" HeaderText="Total Stock" ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
                    <asp:Label ID="lblstock" runat="server" Style="text-align: right;" Text='<%#Eval("TotalStock") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle Width="80px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderStyle-Width="80px" HeaderStyle-BorderColor="Aqua" ItemStyle-BorderColor="Aqua" HeaderText="Order Qty" ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
            ...
            <%-- <asp:TemplateField HeaderStyle-Width="80px" HeaderText="Can. Qty" 
                ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
                    <asp:Label ID="lblrtqty" runat="server" Style="text-align: right;" Text='<%#Eval("CancelQty") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle Width="80px" />
            </asp:TemplateField>--%>
            <asp:TemplateField HeaderStyle-Width="80px" HeaderStyle-BorderColor="red" ItemStyle-BorderColor="Red" HeaderText="Available Qty" ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
    ...
    <script type="text/javascript">
		                ...
		                var table = document.getElementById('<%=Grdvirtualstockreport.ClientID%>');
