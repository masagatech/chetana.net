...
<br />
<br />
<asp:Panel ID="pnlpurch" DefaultButton="btnAdd" CssClass="panelDetails" runat="server" Width="800px" Height="160px">
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pndDetails" runat="server" Width="674px">
            <table style="width: 100%; text-align: right;" runat="server" id="summery">
                <tr>
                    <td>
                        <asp:Label ID="Label5" runat="server" Text="Sub"></asp:Label>
                    </td>
