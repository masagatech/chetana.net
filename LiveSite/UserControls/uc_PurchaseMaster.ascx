    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <asp:TextBox ID="txtremark" runat="server" CssClass="inp-form" Height="15px" 
                    TabIndex="8" 
...
<asp:Panel ID="pnlArea" CssClass="panelDetails" runat="server" Width="710px">
    <table cellpadding="2" cellspacing="2" style="width: 60%">
        ...
        <tr>
            ...
            <td></td>
            <td >
                <asp:Button ID="btnget" runat="server" TabIndex="4" CssClass="submitbtn" Text="Get" Width="80px"
...
<asp:GridView ID="grdpurchaseDetails" runat="server" AutoGenerateColumns="false"
    ...
    PageSize="100" Width="1000px" onrowdatabound="grdpurchaseDetails_RowDataBound">
    <Columns>
