<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_PendingDCEmailed.ascx.cs" Inherits="UserControls_uc_PendingDCEmailed" %>
...
<script>
    function setVal(id) {
        debugger;
        document.getElementById("ctl00_ContentPlaceHolder1_uc_PendingDCEmailed1_txtdocno").value = id;
        document.getElementById("ctl00_ContentPlaceHolder1_uc_PendingDCEmailed1_btnget").click();
