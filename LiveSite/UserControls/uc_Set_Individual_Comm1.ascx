<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_Set_Individual_Comm1.ascx.cs" Inherits="UserControls_uc_Set_Individual_Comm1" %>
...
<div class="section-header">
    <div class="title">
       ...
       Add Individual Commission <a href="Campaigns.aspx" title="back to campaign list"></a>
    </div>
    <div class="options">
    </div>
</div>
 ...
 <asp:Panel ID="PnllGrdComm" runat="server" Width="900px">
   ...
   <div class="actiontab" style="margin-bottom: 6px; width: 940px;">
    ...
    <asp:Button ID="btnSave" CssClass="submitbtn" TabIndex="10" runat="server" Text="Save"
            Width="75px" ValidationGroup="Comm" onclick="btnSave_Click" />
    </td>
        ...
        <Columns>
         ...
         <%--   <asp:TemplateField HeaderStyle-Width="80px" HeaderText="Report Code">
            ...
            <asp:TemplateField HeaderStyle-Width="80px" HeaderText="Dis.From" ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
                    <asp:TextBox ID="TxtDisF" runat="server" AutoPostBack="True" CssClass="inp-form" MaxLength="20" 
            ...
            <asp:TemplateField HeaderStyle-Width="80px" HeaderText="Dis.To" 
                ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
                    <asp:TextBox ID="txtdisTo" runat="server" CssClass="inp-form" MaxLength="20" 
            ...
            ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
                    <asp:TextBox ID="txttarfrm" runat="server" CssClass="inp-form" MaxLength="20" 
            ...
            <asp:TemplateField HeaderStyle-Width="100px" HeaderText="Tar.To">
                <ItemTemplate>
                    <asp:TextBox ID="txttarto" runat="server" CssClass="inp-form" MaxLength="20" 
            ...
            <asp:TemplateField HeaderStyle-Width="100px" HeaderText="Zone.Comm">
                <ItemTemplate>
                    <asp:TextBox ID="txtzcomm" runat="server" CssClass="inp-form" MaxLength="20" 
                        Style="text-align: right;"  Width="90px" 
            ...
            <asp:TemplateField HeaderStyle-Width="100px" HeaderText="Superzone.Comm">
                <ItemTemplate>
                    <asp:TextBox ID="txtscomm" runat="server" CssClass="inp-form" MaxLength="20" 
                        Style="text-align: right;"  Width="90px" 
