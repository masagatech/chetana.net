    ...
    <asp:Panel ID="Panel1" CssClass="pnldash" runat="server" GroupingText="Customer Address Details">
        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 0px">
            ...
            <tr>
                ...
                <td>
                     <asp:TextBox ID="txtStateCode" runat="server" MaxLength="2" CssClass="inp-form" TabIndex="27"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <asp:Panel ID="Panel2" CssClass="pnldash" runat="server">
        <table>
            ...
            <tr>
                ...
                <td width="100px">
                    <asp:Label ID="Label38" runat="server" Text="GST No"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtPAN" runat="server" TabIndex="47" CssClass="inp-form"></asp:TextBox>
