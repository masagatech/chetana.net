<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_DNEdit.ascx.cs" Inherits="UserControls_uc_DNEdit" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
            <ContentTemplate>
                <asp:TextBox ID="txtDNAccode" Width="85px" CssClass="inp-form" TabIndex="2" autocomplete="off"
                   Enabled="false" runat="server" AutoPostBack="True" OnTextChanged="txtDNAccode_TextChanged"></asp:TextBox>
    ...
    <td>
        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
            <ContentTemplate>
                ...
                ValidationGroup="DNedit" ControlToValidate="Txtdocno">.</asp:RequiredFieldValidator>
            </ContentTemplate>
        </asp:UpdatePanel>
    </td>
    <td width="110px">
 ...
 <asp:Panel ID="PnllGrdDN" runat="server" Width="900px">
   ...
   <div class="actiontab" style="margin-bottom: 6px; width: 997px;">
    ...
    <td align="right" width="80px">
        <asp:Button ID="btnSave" CssClass="submitbtn" TabIndex="12" runat="server" Text="Save"
...
<%--   <asp:UpdatePanel ID="upGridData" runat="server">
   ...
   <asp:GridView ID="GrdDN" runat="server" AlternatingRowStyle-CssClass="alt" ShowFooter="true"
        ...
        OnRowDataBound="GrdDN_RowDataBound" TabIndex="10" onrowdeleting="GrdDN_RowDeleting"> 
        <Columns>
         ...
         <%--   <asp:TemplateField HeaderStyle-Width="80px" HeaderText="Report Code">
            ...
            <asp:TemplateField HeaderStyle-Width="80px" HeaderText="DebitAmount" 
                ...
                <ItemTemplate>
                    ...
                    <ajaxCt:FilteredTextBoxExtender ID="filter1" runat="server" 
            ...
            <asp:TemplateField HeaderStyle-Width="80px" HeaderText="CreditAmount" 
                ...
                <ItemTemplate>
                    <asp:TextBox ID="TxtCredit" runat="server" AutoPostBack="True" 
                        CssClass="inp-form" MaxLength="20" Enabled="true"
                        Style="text-align: right;" Width="90px" 
            ...
            <asp:TemplateField HeaderStyle-Width="100px" HeaderText="Comment">
                <ItemTemplate>
                    <asp:TextBox ID="TxtCmmt" runat="server" CssClass="inp-form" Height="20px" 
                        TabIndex="11" TextMode="MultiLine" Width="200px"
  ...
  <asp:ValidationSummary ShowMessageBox="true" ShowSummary="false" ValidationGroup="Entry"
    runat="server" ID="DN1" />
 <asp:ValidationSummary ShowMessageBox="true" ShowSummary="false" ValidationGroup="DNedit"
    runat="server" ID="DN2" />  
...
{
    document.getElementById('ctl00_ContentPlaceHolder1_uc_DNEdit1_btnSave').click();
}
);
