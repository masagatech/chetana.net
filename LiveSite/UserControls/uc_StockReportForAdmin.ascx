<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_StockReportForAdmin.ascx.cs"
    Inherits="UserControls_uc_StockReportForAdmin" %>
...
<div style="float: right; width: 8%">
    <asp:Button ID="btnExport" TabIndex="4" CssClass="submitbtn" runat="server" Text="Export" Visible="false"
    ...
    <asp:GridView ID="Grdstockreport" Width="915px" runat="server" PageSize="2000" AlternatingRowStyle-CssClass="alt"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderStyle-Width="80px" HeaderStyle-BorderColor="red" ItemStyle-BorderColor="Red"
                HeaderText="Net Available" ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
