...
public partial class UserControls_uc_Customer_BlackList_View : System.Web.UI.UserControl
{
    #region Variable
    ...
    public DataSet getBlackListedCustomer(int showdata, int view)
    {
        ...
        try
        {
            ...
            ds = Customer_cs.Idv_Chetana_Customer_BlackList(view, "", date, Convert.ToDecimal(txtRs.Text.Trim()), 1, showdata, 0);
    ...
    protected void btnGetData1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("BalanceConfirmationReport.aspx");
