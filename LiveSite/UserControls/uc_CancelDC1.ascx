...
<div class="section-header">
    <div class="title">
       ...
       Cancel D.C. <a href="Campaigns.aspx" title="back to campaign list"></a>
    </div>
    <asp:Label ID="lblIsPartialC" style="display:none;" runat="server" Text="Label"></asp:Label>
    <div class="options">
    ...
    <asp:GridView ID="grdBookDetails" CssClass="product-table" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Qty" HeaderStyle-Width="20px" ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
                    <asp:Label ID="txtquty" onkeypress="return CheckNumeric(event)" 
                        Style="text-align: right;" runat="server" Text='<%#Eval("Quantity")%>' Width="40px"></asp:Label>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Amount" HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="right"
                ...
                <ItemTemplate>
                    <asp:Label ID="lblAmt"  Style="text-align: right;" runat="server"
...
<script type="text/javascript"> 
 function Openpopup()
   {
        $find('ctl00_ContentPlaceHolder1_uc_CancelDC1_ModalPopUpDocNum').show();
        document.getElementById('ctl00_ContentPlaceHolder1_uc_CancelDC1_TxtDocNo').focus();
        
   }
 function Closepopup()
   {
        $find('ctl00_ContentPlaceHolder1_uc_CancelDC1_ModalPopUpDocNum').hide();
