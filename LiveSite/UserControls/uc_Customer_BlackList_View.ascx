<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_Customer_BlackList_View.ascx.cs"
    Inherits="UserControls_uc_Customer_BlackList_View" %>
...
<asp:Panel ID="pnlfalse" runat="server" CssClass="panelDetails" Width="743px" Height="30px">
    <table style="width: 580px">
        <tr>
            ...
            <td>
                <asp:Button style="display:none;"  ID="btnGetData" runat="server" CssClass="submitbtn" ValidationGroup="pdateft1" Text="Get Details"
                    TabIndex="4" OnClick="btnGetData_Click" />
                    <asp:Button ID="btnGetHistory" runat="server" CssClass="submitbtn" 
                    ValidationGroup="pdateft" Text="Get last blacklisted details"
...
<asp:Panel ID="pnlLedger" runat="server" Width="700px">
    ...
    <div style="float: right; padding-right:75px">
        ...
        CssClass="submitbtn" TabIndex="5" Text="Generate BCR" OnClick="btnGetData1_Click" />
    </div>
    <br />
    <br />
