...
<div class="section-header">
    <div class="title">
        ...
        Sales Performance <a href="Campaigns.aspx" title="back to campaign list"></a>
    </div>
    <div class="options">
    </div>
</div>
...
<asp:Panel ID="Pnl1" CssClass="panelDetails" runat="server" Width="862px">
    <table>
        <tr>
            ...
            <td colspan="2">
                <asp:DropDownList CssClass="ddl-form" ID="DDLsuperzone" DataTextField="SuperZoneName"
                    DataValueField="SuperZoneID" runat="server" TabIndex="1" Width="200px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td width="100px">
                <asp:RadioButtonList ID="rdbselect" runat="server" Style="display: none" RepeatDirection="Horizontal"
                    CssClass="lbl-form" TabIndex="4">
            ...
            <td>
                <asp:Button ID="btnExport" CssClass="submitbtn" TabIndex="6" runat="server" Text="Export"
    ...
    <tr>
        <td valign="top">
            <asp:GridView ID="grdoutstanding" CssClass="product-table" AutoGenerateColumns="False"
                TabIndex="21" Width="600px" runat="server" AlternatingRowStyle-CssClass="alt"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Target Amt." ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                        <ItemTemplate>
                            <asp:Label ID="lbltarget" runat="server" Text='<%#Eval("TargetGiven","{0:0.00}")%>'></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:Label ID="lbltotaltarget" Font-Bold="true" runat="server"></asp:Label>
                        </FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="Other Debit AMT." ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                        <ItemTemplate>
                            <asp:Label ID="lblOtherAmount" runat="server" Text='<%#Eval("OtherAmount","{0:0.00}")%>'></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:Label ID="lbltotalOtherAmount" Font-Bold="true" runat="server"></asp:Label>
                        </FooterTemplate>
                    </asp:TemplateField>
        ...
        <td valign="top">
            <asp:GridView ID="GrdDiscount" CssClass="product-table" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="0 %" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Right">
                        <ItemTemplate>
                            <asp:Label ID="lblzero" runat="server" Text='<%#Eval("0")%>'></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:Label ID="lbltotalzero" Font-Bold="true" runat="server"></asp:Label>
                        </FooterTemplate>
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Right" />
                    </asp:TemplateField>
        ...
        <td valign="top">
            <asp:GridView ID="grdadddiscount" CssClass="product-table" AutoGenerateColumns="true"
                runat="server" AlternatingRowStyle-CssClass="alt" Width="200px" OnRowDataBound="grdadddiscount_RowDataBound" />
        </td>
        <td valign="top">
    ...
    <tr>
        ...
        <td valign="top">
            ...
            <asp:GridView ID="grdcustomer" CssClass="product-table" AutoGenerateColumns="False"
                ...
                ShowFooter="true" OnRowDataBound="grdcustomer_RowDataBound">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Name" HeaderStyle-Width="240px" ItemStyle-HorizontalAlign="Left">
                        ...
                        <FooterTemplate>
                            <asp:Label ID="lblnameCust" Font-Bold="true" runat="server"></asp:Label>
                        </FooterTemplate>
                        <HeaderStyle HorizontalAlign="Center" />
...
<%--<CR:CrystalReportViewer ID="salesperformance" runat="server" AutoDataBind="True"
    EnableTheming="false" SeparatePages="True" HasRefreshButton="True" HasViewList="True"
