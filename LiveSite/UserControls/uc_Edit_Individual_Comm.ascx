...
<asp:Panel ID="PnlAdd" CssClass="panelDetails" runat="server" Width="958px">
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td class="style2">
                <asp:Label ID="Label1" CssClass="lbl-form" runat="server" Text="Super Duper Zone"></asp:Label>
                <font color="red">*</font>
            </td>
            <td>
    ...
    <ContentTemplate>
        <asp:Panel ID="PnllGrdComm" runat="server" Width="900px">
            ...
            <div class="actiontab" style="margin-bottom: 6px; width: 940px;">
                ...
                &nbsp;
                <asp:TextBox ID="txtcnper" runat="server" MaxLength="14" Height="20px" Width="90px"></asp:TextBox>
            </div>
            <div>
                        ...
                        <asp:TemplateField HeaderStyle-Width="100px" HeaderText="Superzone.Comm">
                            <ItemTemplate>
                                <asp:TextBox ID="txtscomm" runat="server" CssClass="inp-form" MaxLength="14"
                                    Style="text-align: right;" Width="90px" Text='<%#Eval("superzoneprcent","{0:0.00}")%>'>
                                </asp:TextBox>
                        ...
                        <asp:TemplateField HeaderStyle-Width="100px" HeaderText="SuperDuperzone.Comm">
                            <ItemTemplate>
                                <asp:TextBox ID="txtsdzcomm" runat="server" CssClass="inp-form" MaxLength="14"
                                    Style="text-align: right;" Width="90px" Text='<%#Eval("sdzonepercent","{0:0.00}")%>'>
                                </asp:TextBox>
...
<div>
    <asp:ValidationSummary ID="ValidationSummary3" runat="server" ShowMessageBox="true" ShowSummary="false" ValidationGroup="AZone" />
</div>
