<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_JVView.ascx.cs" Inherits="UserControls_uc_JVView" %>
...
<div class="section-header">
    <div class="title">
        ...
        JV View<a href="Campaigns.aspx" title="back to campaign list"></a>
    </div>
    <div class="options">
    </div>
</div>
 <asp:Panel ID="PnlAdd" CssClass="panelDetails" runat="server" Width="900px">
  ...
  <tr>
    ...
    <td width="110px">
        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
            <ContentTemplate>
                ...
                ValidationGroup="JVview" ControlToValidate="Txtdocno">.</asp:RequiredFieldValidator>
            </ContentTemplate>
        </asp:UpdatePanel>
    </td>
    ...
    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
        ...
        <%--<asp:RequiredFieldValidator ID="reqdocDate" runat="server" ErrorMessage="Require Document Date "
            ValidationGroup="JVview" ControlToValidate="TxtdocDate">.</asp:RequiredFieldValidator>--%>
         </ContentTemplate>
    </asp:UpdatePanel>
    </td>
    <td width="220px"></td>
...
<ContentTemplate>
 <asp:Panel ID="PnllGrdJv" runat="server" Width="938px">
 ...
 <asp:ValidationSummary ShowMessageBox="true" ShowSummary="false" ValidationGroup="Entry1"
    runat="server" ID="jvE" />
<asp:ValidationSummary ShowMessageBox="true" ShowSummary="false" ValidationGroup="JVview"
    runat="server" ID="jvv" /> 
