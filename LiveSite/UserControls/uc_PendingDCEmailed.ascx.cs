...
public partial class UserControls_uc_PendingDCEmailed : System.Web.UI.UserControl
{
    #region Variables
    decimal SubDocNo = 0;
    bool Auth = false;
    ...
    protected void btnget_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ViewState["EmailID"] = Convert.ToString(ds6.Tables[1].Rows[0]["EmailID"]);
            lblemailid.InnerHtml = Convert.ToString(ds6.Tables[1].Rows[0]["EmailID"]);
  ...
  try
    ...
    protected void btnfind_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Rptrpending.DataSource = DCMaster.GetPendingDocNo_ForViewEmail(0, "deliverydate", Convert.ToDateTime(from), Convert.ToDateTime(To), Convert.ToInt32(strFY));
            Rptrpending.DataBind();
    ...
    protected void btnsearch_Click(object sender, EventArgs e)
    {
        ...
        Rptrpending.DataSource = DCMaster.GetPendingDocNo_ForViewEmail(Convert.ToInt32(DDLCustomer.SelectedValue), "Customer",
    ...
    protected void DDlstate_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (DDlstate.SelectedValue != "0")
        {
           ...
           // DDlCity.DataSource = Destination.GetDestination(Convert.ToString(DDlstate.SelectedValue));
            ...
            Rptrpending.DataSource = DCMaster.GetPendingDocNo_ForViewEmail(Convert.ToInt32(DDlstate.SelectedValue), "City", Convert.ToDateTime("1/11/2001"), Convert.ToDateTime("1/12/2001"), Convert.ToInt32(strFY));
            Rptrpending.DataBind();
    ...
    {
        Rptrpending.DataSource = DCMaster.GetPendingDocNo_ForViewEmail(Convert.ToInt32(DDlCity.SelectedValue), "City", Convert.ToDateTime("1/11/2001"), Convert.ToDateTime("1/12/2001"), Convert.ToInt32(strFY));
        Rptrpending.DataBind();
        if (Rptrpending.Items.Count > 0)
        {
            pnlconfirm.Visible = true;
  ...
  ScriptManager.RegisterClientScriptBlock(Page, Page.GetType(), "window", "f_open_window_max('print/PrintDC.aspx?d=" + txtdocno.Text.Trim() + "&sd=" + Convert.ToInt32(strFY) + "&type=with" + "')", true);
    ...
    public void BindPanel()
    {
        ...
        if (RdBValue == "All")
        {
            ...
            Pnlcust.Visible = false;
            Rptrpending.Visible = true;
            Rptrpending.DataSource = DCMaster.GetPendingDocNoEmail(Convert.ToInt32(strFY));
            Rptrpending.DataBind();
            upOrderNO.Update();
            //  Bind_DDL_SuperZone();  
            pnlconfirm.Visible = true;
