      ...
      <asp:Panel ID="pnldoc123" runat="server">
        ...
        <table>
          ...
          <td>
                            ...
                            <td>
                                <asp:TextBox ID="Txtpod" CssClass="inp-form" runat="server"></asp:TextBox>
                            </td>
                                    <td>
...
<tr>
  <td>
                            ...
                            <td>
                                <asp:TextBox ID="Txtpod1" CssClass="inp-form" runat="server"></asp:TextBox>
                            </td>
                                    <td>
                        ...
                        <ItemTemplate>
                            ...
                            <asp:GridView ID="grdCD" AlternatingRowStyle-CssClass="alt" CssClass="product-table"  AutoGenerateColumns="false" ShowFooter="true" runat="server" OnRowDataBound="grdCD_RowDataBound" >
                                   ...
                                   <asp:TemplateField HeaderText="Sr. No." HeaderStyle-Width="50px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSCMasterAutoId" runat="server" style="display:none" Text='<%#Eval("SCMasterAutoId")%>'></asp:Label>
                            ...
                            <asp:GridView ID="gdGeneral" AlternatingRowStyle-CssClass="alt" CssClass="product-table"  AutoGenerateColumns="false" ShowFooter="true" runat="server" OnRowDataBound="gdGeneral_RowDataBound" >
                                   <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sr. No." HeaderStyle-Width="50px">
                                      ...
                                      <asp:TemplateField HeaderText="Courier ID" HeaderStyle-Width="50px" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSCMasterAutoIdGeneral" runat="server" Text='<%#Eval("SCMasterAutoId")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="UNIQ" HeaderStyle-Width="50px" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblUNIQ" runat="server" Text='<%#Eval("UNIQ")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="POD" ItemStyle-Width="70px" >
                                        <ItemTemplate>
                                        <asp:Label ID="lblAPODIdG" Style="text-align: none; display:none;" runat="server" Text='<%#Eval("PODId")%>'></asp:Label>
                                            <asp:TextBox ID="txtPODIdG" Style="width:70px;" runat="server"
                                                Text='<%#Eval("PODId")%>'></asp:TextBox>
                                    ...
                                    <table style="float: right;" cellspacing="2" cellpadding="2">
                                        ...
                                        <tr>
                                          ...
                                          <asp:Button ID="btnDelte" CommandName="delete" CommandArgument='<%#Eval("SCMasterAutoId")%>' TabIndex="6"
                                                runat="server" Text="Delte POD" CssClass="submitbtn" Width="110px" Style="float: right;
                                                margin: 47px 0 30px 0px" OnClick="btnDelte_Click" />
                                        </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">
