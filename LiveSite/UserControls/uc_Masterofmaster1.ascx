    ...
    <table cellpadding="2" cellspacing="2" style="width: 100%">
        <tr>
            <td>
                ...
                <asp:Label ID="lblkey" runat="server" CssClass="lbl-form" Text="Key"></asp:Label>
                <font color="red">* </font>
            </td>
            <td>
                <asp:TextBox ID="txtkey" TabIndex="1" runat="server" CssClass="inp-form" Width="82px"
                    Style="margin-left: 12px" AutoPostBack="True" OnTextChanged="txtkey_TextChanged"
        ...
        <tr>
            <td>
                <asp:Label ID="lblvalue" runat="server" CssClass="lbl-form" Text="Value"></asp:Label>
                <font color="red">* </font>
            </td>
            <td>
                <asp:TextBox ID="txtvalue" TabIndex="2" runat="server" CssClass="inp-form" Width="186px"
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtdecp" runat="server" TabIndex="3" CssClass="inp-form" TextMode="MultiLine"
                    Width="188px" Style="margin-left: 11px"></asp:TextBox>
            </td>
        </tr>
        <tr id="msoms" runat="server" visible="false">
            <td>
                <asp:Label ID="Label1" runat="server" CssClass="lbl-form" Text="MS/OMS:"></asp:Label>
            </td>
            <td>
                <asp:DropDownList Style="margin-left: 11px;" ID="ddlMSOms" runat="server">
                    <asp:ListItem Text="MS" Selected="True" Value="MS"></asp:ListItem>
...
<asp:ValidationSummary ShowMessageBox="true" ShowSummary="false" ValidationGroup="A"
    runat="server" ID="ss" />
<asp:Panel ID="Panel2" runat="server">
    <asp:GridView ID="GrdDetails" runat="server" AllowPaging="true" AutoGenerateColumns="false"
        ...
        OnRowEditing="GrdDetails_RowEditing" OnRowDeleting="GrdDetails_RowDeleting" OnPageIndexChanging="GrdDetails_PageIndexChanging"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Name" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    ...
                    <asp:Label ID="lblGroup" runat="server" Style="display: none;" Text='<%#Eval("Group")%>'></asp:Label>
                    <asp:Label ID="lblDesc" runat="server" Style="display: none;" Text='<%#Eval("Description")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="OS/OMS" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center"
                Visible="false">
                <ItemTemplate>
                    <asp:Label ID="lblOS_OMS" runat="server"  Text='<%#Eval("OS_OMS")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
