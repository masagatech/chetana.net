<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_ChequeCashDeposit.ascx.cs"
    Inherits="UserControls_ChequeCashDeposit" %>
<%@ Register TagPrefix="ajaxCt" Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" %>
<div class="section-header">
    <div class="title">
        <img src="Images/forms/ico-promotions.png" alt="Edit campaign details" />
        A/C Entries >Check/Cash> Payment Receipt<a href="Campaigns.aspx" title="back to campaign list"></a>
    </div>
</div>
...
<asp:Panel ID="getcheque" runat="server">
    <asp:Panel ID="UpanelGrd" CssClass="panelDetails" runat="server" Width="700px" Height="18px">
        <div class="section-header">
            <div class="title">
                <%--<img src="Images/forms/ico-promotions.png" alt="Edit campaign details" />--%>
                A/C Entries >Edit Payment Panding<a href="Campaigns.aspx" title="back to campaign list"></a>
            </div>
        </div>
        <tr>
            <td>
      ...
      <td>--%>
            ...
            <td>
                <asp:TextBox ID="txtcheque" Width="130px" CssClass="inp-form" runat="server" TabIndex="1"
            ...
            <td>
                ...
                <asp:ValidationSummary ID="valde" runat="server" ShowMessageBox="true" ShowSummary="false"
                    ValidationGroup="Discount4" />
            </td>
        </tr>
        <br />
        <tr>
            <td>
                <asp:Label ID="lblcheque" CssClass="lbl-form" ForeColor="Blue" Font-Size="15px" runat="server"></asp:Label>
            </td>
        </tr>
        </table>
