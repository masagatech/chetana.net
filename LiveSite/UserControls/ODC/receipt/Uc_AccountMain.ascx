<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Uc_AccountMain.ascx.cs"
    Inherits="UserControls_ODC_receipt_Uc_AccountMain" %>
...
<div class="section-header">
    <div class="title">
        ...
        Account Main<a href="Campaigns.aspx" title="back to campaign list"></a>
    </div>
</div>
<div style="float: right; width: 42%">
    <asp:Button ID="btn_Save" CssClass="submitbtn" TabIndex="40" runat="server" Text="Save"
...
<asp:Panel ID="pnlCust" CssClass="panelDetails" runat="server" Width="638px" Height="550px">
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td width="120px">
                ...
                <asp:Label ID="lblPartyName" runat="server" CssClass="lbl-form" Text="AC Name"></asp:Label>
                <font color="red">*</font>
            </td>
            <td>
                <asp:TextBox ID="txtEMcode" autocomplete="off" Width="150px" CssClass="inp-form"
                    TabIndex="1" runat="server" Height="15px"></asp:TextBox>
            ...
            <td>
                <asp:Label ID="lblAcCode" runat="server" CssClass="lbl-form" Text="AC Code"></asp:Label>
                <font color="red">*</font>
            </td>
            <td>
                ...
                <ContentTemplate>
                    ...
                    <td>
                        ...
                        <ajaxCt:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" DelimiterCharacters=""
                            ...
                            CompletionSetCount="10" ServicePath="~/AutoComplete.asmx" CompletionInterval="100"
                            MinimumPrefixLength="1" EnableCaching="false" TargetControlID="txtGroup" UseContextKey="true"
                            ContextKey="GR_HEAD" CompletionListElementID="dvcust">
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtAdd2" AutoComplete="off" Width="150px" CssClass="inp-form" TabIndex="4"
                    runat="server" Height="15px">
                </asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtAdd3" AutoComplete="off" Width="150px" CssClass="inp-form" TabIndex="5"
                    runat="server" Height="15px">
                </asp:TextBox>
            </td>
            <td>
            ...
            <td>
                <asp:TextBox ID="txtBlackList" AutoComplete="off" Width="150px" CssClass="inp-form"
                    TabIndex="14" MaxLength="1" runat="server" Height="15px">
                </asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtpnon1" AutoComplete="off" Width="150px" CssClass="inp-form" TabIndex="6"
            ...
            <td>
                <asp:TextBox ID="txtPincode" AutoComplete="off" Width="150px" CssClass="inp-form"
                    TabIndex="15" MaxLength="10" runat="server" Height="15px">
                </asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtpnon2" onkeypress="return CheckNumeric(event)" AutoComplete="off"
                    Width="150px" CssClass="inp-form" TabIndex="7" MaxLength="10" runat="server" Height="15px">
                </asp:TextBox>
            </td>
            <td>
            ...
            <td>
                <asp:TextBox ID="txtAcIntRate" AutoComplete="off" Width="150px" CssClass="inp-form"
                    TabIndex="16" runat="server" Height="15px" onkeypress="return CheckNumericWithDot(event)">
                </asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtCityCode" AutoComplete="off" Width="150px" CssClass="inp-form"
                    TabIndex="8" runat="server" Height="15px">
                </asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtPin" AutoComplete="off" Width="150px" CssClass="inp-form" TabIndex="9"
                    runat="server" Height="15px">
                </asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtbroker" AutoComplete="off" Width="150px" CssClass="inp-form"
                    TabIndex="10" runat="server" Height="15px"> 
                </asp:TextBox>
                <div id="dvcust" class="divauto">
                </div>
                <ajaxCt:AutoCompleteExtender ID="cust_AutoCompleteExtender" runat="server" DelimiterCharacters=""
                    ...
                    CompletionListHighlightedItemCssClass="AutoExtenderHighlight" Enabled="True" ServiceMethod="GetCodes"
                    CompletionSetCount="10" ServicePath="~/AutoComplete.asmx" CompletionInterval="100"
                    MinimumPrefixLength="1" EnableCaching="false" TargetControlID="txtbroker" UseContextKey="true"
                    ContextKey="Broker" CompletionListElementID="dvcust">
                </ajaxCt:AutoCompleteExtender>
            </td>
            <td>
