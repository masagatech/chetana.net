<%@ Control Language="C#" AutoEventWireup="true" CodeFile="InvoiceDeliverStatus.ascx.cs" Inherits="UserControls_ODC_receipt_InvoiceDeliverStatus" %>
...
<asp:Panel ID="pnlcust" runat="server" CssClass="panelDetails" Width="280" Height="200px">
    <table>
        <tr>
            ...
            <td>
                 <asp:TextBox ID="txtInvoive" Enabled="true" runat="server" TabIndex="1" Style="margin-left: 0px" AutoPostBack="true"
