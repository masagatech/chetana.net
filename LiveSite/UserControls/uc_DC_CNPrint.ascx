...
<asp:Panel ID="Pnldate" CssClass="panelDetails" runat="server" Width="863px">
    <table>
        <tr>
            <td colspan="4">
                <asp:RadioButtonList ID="RdbtnSelect" runat="server" RepeatDirection="Horizontal"
                    ...
                    <asp:ListItem Value="CN" Selected="True" Text="DateWise"></asp:ListItem>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btngetcust" runat="server" Text="Get" CssClass="submitbtn" TabIndex="4" ValidationGroup="dateft"
