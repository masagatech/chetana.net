...
public partial class UserControls_ODC_uc_DC_EditCN : System.Web.UI.UserControl
{
    ...
    protected void RdbtnSelect_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (RdbtnSelect.SelectedValue == "GCN")
        {
            Pnl3.Visible = true;
            Pnl4.Visible = false;
            Pnl1.Visible = false;
            ...
            btngetcust.Visible = false;
        }
        if (RdbtnSelect.SelectedValue =="LR")
        {
            Pnl4.Visible = true;
            Pnl3.Visible = false;
            Pnl1.Visible = false;
   ...
   (e.Row.RowState == DataControlRowState.Normal ||
    ...
    #endregion
    protected void btngcn_Click(object sender, EventArgs e)
    {
        RptrCN2.DataSource = CreditNote.GetCNNo_byCusts(Convert.ToInt32(strFY), (Txtgcnno.Text), "GCN");
        RptrCN2.DataBind();
    ...
    protected void grdcn_RowDeleted(object sender, GridViewDeletedEventArgs e)
    {
