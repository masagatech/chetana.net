                                    ...
                                    <tr>
                                        ...
                                        <%-- <td align="right">
                                            <asp:Button ID="btnConfirmed" CommandArgument='<%#Eval("SubConfirmID")%>' OnClick="btnapproval_Click" s
                                                TabIndex="3" Style="display: none; float: right;" runat="server" Text="Create Invoice" CssClass="submitbtn" Width="110px"
                                                Style="float: right;" />
                                        </td>--%>
                                    </tr>
                                </table>
                                        ...
                                        <tr>
                                            <td align="left" colspan="2">
                                                <asp:Button ID="btnConfirmed" CommandArgument='<%#Eval("SubConfirmID")%>' OnClick="btnapproval_Click"
                                                    ...
                                                    Style="display: none; float: right;" OnClientClick="return confirm('Do you want to Create Invoice ?');" />
                                            </td>
                                            ...
                                            <td align="left" colspan="2">
                                                <asp:Button ID="Button1" CommandArgument='<%#Eval("SubConfirmID")%>' OnClick="btnPrint_Click"
                                                    ...
                                                    Style="display: none; float: right;" OnClientClick="return confirm('Do you want to Create and Print Invoice ?');" />
                                            </td>
