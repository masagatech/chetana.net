...
<asp:Panel ID="PnlAdd" CssClass="panelDetails" runat="server" Width="958px">
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td colspan="2" align="center">Discount(%)
            </td>
            <td colspan="2" align="center">Target(%)
            </td>
            <td colspan="2" align="center">Commission(%)
            </td>
            <td width="110px"></td>
            <td width="110px"></td>
        </tr>
        <tr>
            <td width="110px" align="center">From
            </td>
            <td width="110px" align="center">To
            </td>
            <td width="110px" align="center">From
            </td>
            <td width="110px" align="center">To
            </td>
            <td width="110px" align="center">Zone
            </td>
            <td width="110px" align="center">Super Zone
            </td>
            <td width="110px" align="center">Super Duper Zone
            </td>
            <td width="110px" align="center">Active
            </td>
        ...
        <tr>
            ...
            <td align="center">
                <asp:TextBox ID="txtCommSDZone" runat="server" Width="70px"></asp:TextBox>
            </td>
            <td align="center">
                <asp:CheckBox ID="chkActive" runat="server" Text="" OnCheckedChanged="chkActive_CheckedChanged" Checked="True" />
            </td>
        </tr>
    </table>
</asp:Panel>
