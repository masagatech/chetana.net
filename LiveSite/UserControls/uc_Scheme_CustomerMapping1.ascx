...
<div style="float: right; width: 60%">
    <asp:Button ID="btn_Save" CssClass="submitbtn" TabIndex="7" runat="server" Text="Save"
...
<asp:Panel ID="Panel1" CssClass="panelDetails" runat="server" Width="480px">
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr style="display:none">
            <td>
                <asp:CheckBox ID="chkIss" TabIndex="13" runat="server" Text="   ISS" Checked="true"  />
            </td>
        </tr>
    </table>
</asp:Panel>
...
<asp:Panel ID="Panel2" runat="server">
    <asp:GridView ID="GrdDetails" runat="server" AllowPaging="true" AutoGenerateColumns="false"
        ...
        OnRowEditing="GrdDetails_RowEditing" OnRowDeleting="GrdDetails_RowDeleting" AlternatingRowStyle-CssClass="alt">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Name" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    ...
                    <asp:Label ID="lblCustCode" runat="server" Style="display: none;" Text='<%#Eval("CustCode")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
