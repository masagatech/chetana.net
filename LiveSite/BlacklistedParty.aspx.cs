...
public partial class BlacklistedParty : System.Web.UI.Page
{
    #region Variables
    int CID;
    string flag = "state";
    ...
    public void ShowDetails()
    {
        ...
        ds = Idv.Chetana.BAL.Customer_cs.Idv_Chetana_Rep_Customer_BlacklistedParty(DDLCC.SelectedValue.ToString(), Convert.ToInt32(ddlCustmore.SelectedValue.ToString()), Convert.ToInt32(strFY),
           Convert.ToInt32(DDLSuperZone.SelectedValue.ToString()), Convert.ToInt32(DDLZone.SelectedValue.ToString()));
        DataView dv = new DataView(ds.Tables[0]);

        ReportDocument rd = new ReportDocument();
        rd.Load(Server.MapPath("Report/BlacklistedParty.rpt"));
    ...
    {
        ddlCustmore.DataSource = Masters.Idv_Chetana_Get_ZoneCustomerBlackList(Convert.ToInt32(DDLZone.SelectedValue.ToString()));
