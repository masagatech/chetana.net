<%@ Page Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true"
    CodeFile="SalesReport_BkwiseCust_Summary.aspx.cs" Inherits="SalesReport_BkwiseCust_Summary"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="section-header">
        <div class="title">
            ...
            Bookwise Customer Pending Sales Summary <a href="Campaigns.aspx" title="back to campaign list">
            </a>
        </div>
    </div>
    <div>
        <asp:Panel ID="pnldt" CssClass="panelDetails" runat="server" Width="735px">
            <table>
                ...
                <tr>
                    <td colspan="4">
                        <asp:RadioButtonList ID="RdbtnSelect" runat="server" RepeatDirection="Horizontal"
                            TabIndex="3" Width="180px" AutoPostBack="True" OnSelectedIndexChanged="RdbtnSelect_SelectedIndexChanged">
                ...
                <tr>
                    ...
                    <td >
                        <asp:TextBox ID="txtfromDate" runat="server" CssClass="inp-form" Enabled="true" TabIndex="5"
                    ...
                    <td>
                        <asp:Button ID="btnget" runat="server" CssClass="submitbtn" OnClick="btnget_Click"
                            TabIndex="7" Style="height: 26px" Text="Get" ValidationGroup="bkwSummary" Width="80px" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
