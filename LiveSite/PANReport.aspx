<%@ Page Title="Missing PAN No" Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="PANReport.aspx.cs" Inherits="PANReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="section-header">
        <div class="title">
            ...
            Missing PAN No<a href="Campaigns.aspx" title="back to campaign list"></a>
        </div>
    ...
    <%--<asp:UpdatePanel ID="updatePen" runat="server" UpdateMode="Conditional">
        <ContentTemplate>--%>
    <asp:Panel ID="pnlnew" runat="server" DefaultButton="btnGet" CssClass="panelDetails" Width="720px" Height="25px">
        ...
        <asp:Label ID="Label3" runat="server" CssClass="lbl-form" Text="S.D. Zone"></asp:Label>
        <asp:DropDownList ID="DDLSDZone" runat="server" TabIndex="1" AutoPostBack="true" CssClass="ddl-form"
            DataTextField="SDZoneName" DataValueField="SDZoneId" OnSelectedIndexChanged="DDLSDZone_SelectedIndexChanged"
            Width="200px">
        </asp:DropDownList>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required SD Super Zone"
            ValidationGroup="V" ControlToValidate="DDLSDZone" InitialValue="0">*</asp:RequiredFieldValidator>
        ...
        <asp:Button ID="btnGet" runat="server" CssClass="submitbtn" Text="Get" Width="53px" TabIndex="4"
