<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="CustOutstanding.aspx.cs" Inherits="CustOutstanding" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <asp:Panel ID="pnlcust" runat="server" CssClass="panelDetails" Width="780px" Height="75px">
            <table>
                <tr>
                    <td>
                        <asp:RadioButtonList Visible="false" runat="server" ID="rdbselect" TabIndex="1" RepeatDirection="Horizontal"
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:RequiredFieldValidator ID="RFVCust" runat="server" ErrorMessage="Require Customer Code"
                                                    ValidationGroup="AZone" ControlToValidate="txtcustomer">.</asp:RequiredFieldValidator>
