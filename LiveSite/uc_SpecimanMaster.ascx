<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_SpecimanMaster.ascx.cs"
    Inherits="UserControls_SpecimanMaster" %>
...
<br />
<br />
<asp:Panel ID="PnlSpecimenDetails" CssClass="panelDetails" runat="server" style="width:589px;">
    <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtorder" CssClass="inp-form" Width="80px" TabIndex="5" runat="server"
                            OnTextChanged="txtorder_TextChanged" AutoPostBack="true" MaxLength="10"></asp:TextBox></ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td>
        ...
        <tr>
            ...
            <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                    <ContentTemplate>
                  <asp:TextBox ID="txtspInstruct" Width="130px" CssClass="inp-form" TabIndex="8" 
        ...
        <tr>
            <td colspan="2">
                <asp:Panel runat="server" ID="Panel1" DefaultButton="btngetset">
                    <asp:DropDownList CssClass="ddl-form" Width="160px" ID="DDLSelectSet" TabIndex="9" runat="server"
                        DataTextField="Value" DataValueField="AutoId">
                    </asp:DropDownList>
                    <asp:TextBox ID="txtsetqty" TabIndex="10" Width="30px" CssClass="inp-form" Style="text-align: right;"
            ...
            <td colspan="3">
                <asp:Panel runat="server" ID="aa" DefaultButton="btnaddBooks">
                 ...
                 <asp:DropDownList CssClass="ddl-form" ID="DDlstandard" TabIndex="10" runat="server"
                    ...
                    <ajaxCt:TextBoxWatermarkExtender runat="server" TargetControlID="txtbkcod" WatermarkText="Enter BookCode to add  ">
                    </ajaxCt:TextBoxWatermarkExtender>
        ...
        <asp:GridView  ID="grdBookDetails" CssClass="product-table" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderStyle-Width="20px" HeaderText="Quantity" ItemStyle-HorizontalAlign="right">
                    <ItemTemplate>
                        <asp:TextBox ID="txtquty" runat="server" onkeypress="return CheckNumeric(event)" AutoComplete ="off"
...
<asp:Panel ID="PnlInsertDocNum" runat="server" DefaultButton="BtnGetSpecimanDetails"
    ...
    <div class="facebox">
        <asp:Label ID="Label9" runat="server" Style="float: left; font-size: 11px; font-weight: bold"
            ForeColor="White"></asp:Label>
        <a class="close" runat="server" href="javascript:void(0);" onclick="Closepopup(2);">
