<%@ Page Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="Edit_PurchaseMaster.aspx.cs" Inherits="Edit_PurchaseMaster" Title="Edit Purchase Master" %>
...
<asp:Panel ID="pnlpurch" CssClass="panelDetails" runat="server" Width="800px" Height="160px">
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td><asp:Button ID="btnAdd" CssClass="submitbtn" ValidationGroup="ct" runat="server"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Quantity" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
            <ItemTemplate>
                ...
                <asp:TextBox ID="lblQuantity" runat="server" Width ="60px" onkeypress="return CheckNumeric(event)"  Text='<%#Eval("Quantity") %>'></asp:TextBox>
            </ItemTemplate>
            <FooterTemplate>
        ...
        <asp:TemplateField HeaderText="Rate" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
            <ItemTemplate>
                <asp:TextBox ID="lblRate" runat="server" Text='<%#Eval("Rate","{0:0.00}") %>' Width ="50px" onkeypress="return CheckNumeric(event)"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Discount" ItemStyle-HorizontalAlign="Right">
            <ItemTemplate>
                <asp:TextBox ID="lblDisc" runat="server" Text='<%#Eval("Discount","{0:0.00}") %>'  Width ="50px"></asp:TextBox> 
