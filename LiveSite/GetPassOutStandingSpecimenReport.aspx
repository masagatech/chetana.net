<%@ Page Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="GetPassOutStandingSpecimenReport.aspx.cs" Inherits="GetPassOutStandingSpecimenReport" Title="Out Speciman Print" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <CR:CrystalReportViewer ID="GetPassSpecimen" runat="server" AutoDataBind="true"
