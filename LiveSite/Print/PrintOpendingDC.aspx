<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintOpendingDC.aspx.cs" Inherits="Print_PrintOpendingDC" %>
...
<body onunload="clickbtn()">
    ...
    <div>
        ...
        <table width="780px">
            <tr>
                <td>
                    <asp:GridView ID="grdpending" CssClass="product-table"
                        AutoGenerateColumns="false" FooterStyle-CssClass="gridf" runat="server" Width="700px"
                        ShowFooter="true" GridLines="None" CellPadding="2" 
                        onrowdatabound="grdpending_RowDataBound" >
                        <Columns>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lbldocNo" Style="display: none;" runat="server" Text='<%#Eval("DocumentNo")%>'></asp:Label>
                            ...
                            <asp:TemplateField HeaderText=" Qty" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Right"
                                 FooterStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                                <asp:Label ID="lblqunty" Style="text-align: right;" runat="server" Text='<%#Eval("RemainQty") %>'></asp:Label>
                                <asp:Label ID="Label1" Style="text-align: right;display:none" runat="server" Text='<%#Eval("Quantity")%>'></asp:Label>
                                 <asp:Label ID="lblTotalQty" Style="text-align: right;display:none" runat="server" Text=""></asp:Label>
