...
public partial class UserControls_uc_ChetanaSendCourier : System.Web.UI.UserControl
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try 
        {
            ...
            _objCD.Save(Convert.ToString(ViewState["DocNo"]), "InvoiceNoGrid", Convert.ToInt16(strFY), Convert.ToInt16(ddlCourier.SelectedValue.ToString()), Convert.ToInt16(ddlBranch.SelectedValue.ToString()),txtAddress.Text.ToString(), Convert.ToString(Session["UserName"]), out SCD);
