<%@ Page Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true"
    CodeFile="TotalCNbydt.aspx.cs" Inherits="TotalCNbydt" Title="TotalCN BY DATE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <div class="section-header">
            <div class="title">
                ...
                DateWise CN <a href="Campaigns.aspx" title="back to campaign list"></a>
            </div>
            <div class="options">
            </div>
    ...
    <input name="filt" onkeyup="filter(this, 'sf', '<%=grdDetails.ClientID%>')" id="filterdata"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="Rfvfdt" runat="server" ErrorMessage="Require From Date"
                            ValidationGroup="totalcn" ControlToValidate="txtfromDate">.</asp:RequiredFieldValidator>
                    </td>
                    <td width="30px">
                    </td>
                    <td width="60px">
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="Rfvtdt" runat="server" ErrorMessage="Require To Date"
                            ValidationGroup="totalcn" ControlToValidate="txttoDate">.</asp:RequiredFieldValidator>
                    </td>
                    <td width="30px">
                    </td>
                    <td>
                        <asp:Button ID="btnget" runat="server" Width="80px" TabIndex="3" Text="Get" CssClass="submitbtn"
                            ValidationGroup="totalcn" OnClick="btnget_Click" Style="height: 26px" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        <br />
        <br />
        <CR:CrystalReportViewer ID="CrptTotalCN" runat="server" AutoDataBind="true" DisplayGroupTree="false"
        ...
        <asp:ValidationSummary ShowMessageBox="true" ShowSummary="false" ValidationGroup="totalcn"
            runat="server" ID="ss" />
    </div>
</asp:Content>
