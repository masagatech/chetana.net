<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="AdditionalCommissionCal.aspx.cs" Inherits="AdditionalCommissionCal" %>
    ...
    <div>
        ...
        <asp:Panel ID="pnlcust" runat="server" CssClass="panelDetails" Width="700px" Height="50px">
            ...
            <td>
                    ...
                    <td>
                        <asp:Button ID="btnSave" CssClass="submitbtn"  runat="server" Text="GetData"
                            Width="60px" ValidationGroup="AZone" OnClick="btnSave_Click" />
                    </td>
                    <td>
                    <asp:Button ID="btnExport" CssClass="submitbtn"  runat="server" Text="Export"
                            Width="50px" ValidationGroup="AZone" OnClick="btnExport_Click" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        ...
        <div style=" float: left; margin: 15px 0 0; text-align: center; width: 70%;">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                    ...
                                    <asp:GridView ID="grdAddCommCal" AlternatingRowStyle-CssClass="alt" CssClass="product-table"  AutoGenerateColumns="false" ShowFooter="true" runat="server">
                                    <Columns>
