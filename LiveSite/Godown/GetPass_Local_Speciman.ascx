<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GetPass_Local_Speciman.ascx.cs"
    Inherits="Godown_GetPass_Local_Speciman" %>
<%@ Register TagPrefix="ajaxCt" Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" %>
<div class="section-header">
    <td>
        <div class="title">
            <img src="Images/forms/ico-promotions.png" alt="Edit campaign details" />
            <span runat="server" id="pageName">Get Pass Local Speciman</span><a href="Campaigns.aspx"
...
<div style="float: left; width: 555px">
    <%--<asp:UpdatePanel ID="updatebtn" runat="server" UpdateMode="Conditional">
        <ContentTemplate>--%>
    <asp:Button ID="btnClear" Style="float: right; margin: 0px 0px 0px 2px" CssClass="submitbtn" Enabled="true"
    ...
    <asp:Button ID="btn_Edit" Visible="false" Style="float: right; margin: 0px 2px 0px 2px" Enabled="true"
    ...
    <asp:Button ID="btn_PrintSave" Visible="false" Style="float: right; margin: 0px 2px 0px 2px" Enabled="true"
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <ajaxCt:AutoCompleteExtender ID="Area_AutoCompleteExtender" runat="server" CompletionInterval="100"
                                CompletionListCssClass="AutoExtender" CompletionListElementID="dvcust" CompletionListHighlightedItemCssClass="AutoExtenderHighlight"
                                CompletionListItemCssClass="AutoExtenderList" CompletionSetCount="20" ContextKey="area"
                                DelimiterCharacters="" EnableCaching="false" Enabled="True" MinimumPrefixLength="3"
                                ServiceMethod="GetCodes" ServicePath="~/AutoComplete.asmx" TargetControlID="txtArea"
                                UseContextKey="true">
                            </ajaxCt:AutoCompleteExtender>
                        </td>
                        <td>
