    ...
    public void fillDataDocNo(int isNew)
    {
        ...
        if (isNew == 1)
        {
            ...
            if (rdoview.Items[0].Selected == true)
            {
                ...
                ds = G_GetPass.Railway_Report("dcno", Convert.ToInt32(fdcno), Convert.ToInt32(tdcno), System.DateTime.Now, System.DateTime.Now, Convert.ToInt32(strFY));
            }
            else if (rdoview.Items[1].Selected == true)
            {
                ...
                ds = G_GetPass.Railway_Report("", 0, 0, _objfdate, _objtdate, Convert.ToInt32(strFY));
            ...
            else if (rdoview.Items[2].Selected == true)
            {
                fdcno = txtfdocno.Text.Trim();
                tdcno = txttdocno.Text.Trim();
                ds = G_GetPass.Railway_Report("orgdcno", Convert.ToInt32(fdcno), Convert.ToInt32(tdcno), System.DateTime.Now, System.DateTime.Now, Convert.ToInt32(strFY));
        ...
        if (ViewState["DocNoRep"] != null)
        {
            try
            {
                rd.Load(Server.MapPath("Godown/reports/RailDateReport.rpt"));
