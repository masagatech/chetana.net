<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GetOut_Customer_Delivery.ascx.cs" Inherits="Godown_GetOut_Customer_Delivery" %>
...
<div class="section-header">
    <div class="title">
        ...
        Generate Transporter Parcel Delivery Report<a href="Campaigns.aspx" title="back to campaign list"></a>
    </div>
    <div class="options">
    </div>
</div>
<div style="width: 558px">
    <asp:Button ID="btnget" Style="float: right; margin: 0px 0px 0px 2px" CssClass="submitbtn" TabIndex="3"
        runat="server" Text="Generate Report" OnClick="btnget_Click" ValidationGroup="v1" />
        ...
        <tr>
            <td align="left" colspan="2" valign="top" >
                <asp:RadioButtonList CellPadding="2" CellSpacing="2" ID="rdoview" runat="server"
                    ...
                    <asp:ListItem Value="Transporter" Text="Transporter Wise"></asp:ListItem>                   
                </asp:RadioButtonList>
            </td>
            ...
            <asp:GridView ID="grdTemp" runat="server" AutoGenerateColumns="False" AlternatingRowStyle-CssClass="alt" RowStyle-HorizontalAlign="Center"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="ID">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lCustid" Text='<%#Eval("ID") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
...
<asp:Panel ID="Panel2" runat="server" Width="480px">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:GridView ID="grdTransport" runat="server" AutoGenerateColumns="False" AlternatingRowStyle-CssClass="alt" RowStyle-HorizontalAlign="Center"
                CellPadding="4" CssClass="product-table" OnRowDeleting="grdTransport_RowDeleting">
                <Columns>
                    
                    <asp:TemplateField HeaderText="Transport Code">
                        <ItemTemplate>
                            <asp:Label ID="lblCustName" runat="server" Text='<%#Eval("Transport_Code") %>'></asp:Label>
 <asp:Label runat="server" ID="G_lblCustid" style="display:none"  Text='<%#Eval("Transport_ID") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Transport Name">
                        <ItemTemplate>
                            <asp:Label ID="lblArea" runat="server" Text='<%#Eval("Transport_Name") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Del." HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
...
<br />
<CR:CrystalReportViewer ID="OutDate" runat="server" AutoDataBind="true" DisplayGroupTree="false"
...
<CR:CrystalReportViewer ID="OutVehicle" runat="server" AutoDataBind="true" DisplayGroupTree="false"
    EnableDatabaseLogonPrompt="false" EnableDrillDown="false" EnableParameterPrompt="false"
    EnableTheming="false" HasDrillUpButton="false" HasPageNavigationButtons="true"
    HasRefreshButton="true" HasSearchButton="false" HasViewList="false" HasZoomFactorList="false"
    Height="1039px" Width="773px" ShowAllPageIds="True" />
<CR:CrystalReportViewer ID="OutCustomer" runat="server" AutoDataBind="true" DisplayGroupTree="false"
    EnableDatabaseLogonPrompt="false" EnableDrillDown="false" EnableParameterPrompt="false"
    EnableTheming="false" HasDrillUpButton="false" HasPageNavigationButtons="true"
    HasRefreshButton="true" HasSearchButton="false" HasViewList="false" HasZoomFactorList="false"
    Height="1039px" Width="773px" ShowAllPageIds="True" />
