<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RailwayZone.ascx.cs" Inherits="Godown_RailwayZone" %>
...
<br />
<CR:CrystalReportViewer ID="RailwayDocNo" runat="server" AutoDataBind="true" 
    ...
    HasRefreshButton="true" HasSearchButton="false" HasZoomFactorList="false"
