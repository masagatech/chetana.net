<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Get_Railway.ascx.cs" Inherits="Godown_Get_Railway" %>
...
<div class="section-header">
    <div class="title">
        ...
        Generate Railway Register Report<a href="Campaigns.aspx" title="back to campaign list"></a>
    </div>
    <div class="options">
    </div>
</div>
...
<div style="width: 558px">
    <asp:Button ID="btnget" Style="float: right; margin: 0px 0px 0px 2px" CssClass="submitbtn" TabIndex="3"
        ...
        <%--<a  href="Get_Railway.ascx.cs">Get_Railway.ascx.cs</a>--%>
...
<br />
<CR:CrystalReportViewer ID="RailwayDocNo" runat="server" AutoDataBind="true" DisplayGroupTree="false"
