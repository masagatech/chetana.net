<%@ Page Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true"
    CodeFile="CNProgrammeChart.aspx.cs" Inherits="CNProgrammeChart" Title="CN Progaramme Chart" %>
    ...
    <div class="section-header">
        <div class="title">
            <div style="float: right; width: 101%">
                ...
                CN Programme Chart<a href="Campaigns.aspx" title="back to campaign list"></a>
            </div>
        </div>
    </div>
    <div>
        ...
        <asp:Panel ID="pnlcust" runat="server" CssClass="panelDetails" Width="820px" Height="90px">
            <table border="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <ajaxCt:MaskedEditExtender ID="fromDate" runat="server" TargetControlID="txtTo" MaskType="Date"
                            ...
                            CultureName="en-US" />
                        <asp:Label runat="server" ID="lblfrmNo">Form No</asp:Label>
                        <asp:TextBox runat="server" ID="txtfrmNo" MaxLength="10" Columns="6"></asp:TextBox>
                    </td>
                ...
                <td></td><td></td><td></td>
                    <td  align="right"> 
                        <asp:Label runat="server" ID="Label1">Next No</asp:Label>
                        <asp:TextBox runat="server" ID="txtshowno" Enabled="false" MaxLength="10" Columns="6"></asp:TextBox>
                        
                    </td>
                    <td colspan="2" align="center">
                    <asp:Button ID="btnsaveno" CssClass="submitbtn" TabIndex="8" runat="server" Text="Submit"
                            Width="80px" onclick="btnsaveno_Click" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        ...
        <CR:CrystalReportViewer ID="CustomerWiseAmount" runat="server" AutoDataBind="true"
            ...
            Height="1039px" Width="773px" HasSearchButton="True" />
    </div>
</asp:Content>
