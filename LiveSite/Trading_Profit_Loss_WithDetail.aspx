<%@ Page Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="Trading_Profit_Loss_WithDetail.aspx.cs" Inherits="Trading_Profit_Loss_WithDetail" Title=" Trading Profit and Loss" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="title">
       ...
       Trading Profit and Loss Account <a href="Campaigns.aspx" title="back to campaign list"></a>
    </div>
</div>
...
<asp:Panel ID="pnlcust" runat="server" CssClass="panelDetails" Height="40px" Width="735px">
         ...
         <br />
        <br />
        <cr:crystalreportviewer id="BSReport" runat="server" 
