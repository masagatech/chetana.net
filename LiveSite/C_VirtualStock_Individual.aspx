...
CodeFile="C_VirtualStock_Individual.aspx.cs" Inherits="C_VirtualStock_Individual" Title="Cnf Virtial Stock" %>
    ...
    <asp:Panel ID="pnlfalse" runat="server" CssClass="panelDetails" Width="630px" Height="30px">
        <table style="width: 631px">
            <tr>
                ...
                <td>
                    <asp:CheckBox runat="server" ID="IsPrint" Visible="false" Checked="true" Text="  Is Date Print" />
    ...
    <asp:Panel ID="pnlLedger" runat="server">
        <div style="float: right; display: none;" runat="server" id="totAlAmt">
         ...
         <CR:CrystalReportViewer ID="Cnfaccountingledger" runat="server" AutoDataBind="true"
            ...
            HasGotoPageButton="False" SeparatePages="False" HasPageNavigationButtons="False" HasRefreshButton="true"
