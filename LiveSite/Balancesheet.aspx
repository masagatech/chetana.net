<%@ Page Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="Balancesheet.aspx.cs" Inherits="Balancesheet" Title="Chetana : Balance Sheet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    ...
    <div class="title">
        ...
        Balance Sheet<a href="Campaigns.aspx" title="back to campaign list"></a>
    </div>
</div>
