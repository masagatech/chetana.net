<%@ Page Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="SalesReport_Bkwise_ZonalDetail.aspx.cs" Inherits="SalesReport_Bkwise_ZonalDetail" Title="ZonalDetail Book Sales" %>
      ...
      <td width="70px">
        ...
        <td>
            <asp:DropDownList ID="DDLsuperzone" runat="server" ValidationGroup="bkwZonal"
                 TabIndex="2" DataTextField="SuperZoneName" DataValueField="SuperZoneID" Width="152px">
            </asp:DropDownList>
             <asp:RequiredFieldValidator ID="Rfvfsz" runat="server" ErrorMessage="Require SuperZone"
                    ValidationGroup="bkwZonald" ControlToValidate="txtfromDate">.</asp:RequiredFieldValidator>
         </td>
    </tr>
     <tr>
    <td width="10px">
        ...
        <td>
             <asp:TextBox ID="txttoDate" CssClass="inp-form" TabIndex="6" Width="80px" runat="server"
                ...
                <asp:RequiredFieldValidator ID="Rfvtdt" runat="server" ErrorMessage="Require To Date"
                    ValidationGroup="bkwZonald" ControlToValidate="txttoDate">.</asp:RequiredFieldValidator>
        </td>
        <td>
             <asp:Button ID="btnget" runat="server" width="80px" Text="Get" CssClass="submitbtn" ValidationGroup="bkwZonald"
               TabIndex="7" onclick="btnget_Click" style="height: 26px" />
        </td>
      </tr>
</table>
</asp:Panel>
<br />
<br />
<cr:crystalreportviewer id="CrptBkwiseZonald" runat="server" 
            ...
            ShowAllPageIds="True" />
            <asp:ValidationSummary ShowMessageBox="true" ShowSummary="false" ValidationGroup="bkwZonald"
    runat="server" ID="ss" />
</div>
