<%@ Page Title="Exception Report" Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="ExpReport.aspx.cs" Inherits="ExpReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="section-header">
        <div class="title">
            ...
            <span runat="server" id="pageName"></span>Cash Exception Report<a href="Campaigns.aspx"
                title="back to campaign list"></a>
        </div>
    </div>
    <asp:Panel ID="pnlDetails" runat="server" CssClass="panelDetails" Width="475px">
        ...
        <asp:Panel ID="pnlbanktext" runat="server" Width="480px" style="display:none">
            <table style="width: 480px">
                <tr>
                    <td width="80px">
