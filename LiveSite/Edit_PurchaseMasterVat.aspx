...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1"  runat="Server">
    ...
    <br />
    <br />
    <asp:Panel ID="pnlpurch" CssClass="panelDetails" runat="server" DefaultButton="btnAdd"  Width="800px"  Height="160px">
        ...
        <ContentTemplate>
            <asp:Panel ID="pndDetails" runat="server" Width="786px">
                ...
                <table style="width: 100%; text-align: right;" runat="server" id="summery">
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="txtPercentage" AutoPostBack="true" Style="text-align:right;" 
                            ontextchanged="txtPercentage_TextChanged" Visible="false" onkeypress="return CheckNumericWithDot(event)"></asp:TextBox>
                        <%--<asp:Label ID="Label8" runat="server" Text="0"></asp:Label>--%>
                    </td>
                </tr>
                    <tr>
                        <td>
                            <asp:Label ID="lblVatper" runat="server" Text="VAT Amount"></asp:Label>
                        </td>
                        <td>
                        ...
                        Text="0" style="text-align:right" ontextchanged="txtVatAmt_TextChanged"></asp:TextBox>
                            ...
                            <asp:Label ID="lblVatAmt" runat="server" Visible="false" Text="0"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
