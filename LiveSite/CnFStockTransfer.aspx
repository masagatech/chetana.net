<%@ Page Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="CnFStockTransfer.aspx.cs" Inherits="StockTransfer_Cnf" Title="CnF Stock Transfer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="section-header">
        <div class="title">
            ...
            CnF Stock Transfer<a href="Campaigns.aspx" title="back to campaign list"></a>
        </div>
    ...
    <asp:Panel ID="StockTransferPanel" runat="server">
    ...
    <br />
            <asp:GridView ID="Grdstockreport" runat="server"
                ...
                PageSize="2000"
                Width="915px">
                <%--onselectedindexchanged="Grdstockreport_SelectedIndexChanged"--%>
                <Columns>
             ...
             <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-Width="80px"
                        ...
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="lbltotolstock" runat="server" Text='<%#Eval("TotalStock")%>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle Width="80px" />
                        <ItemStyle HorizontalAlign="Right" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderStyle-Width="80px"
                        HeaderText="Debit Quantity"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="lblDebitQty" runat="server" Text='<%#Eval("DebitQty")%>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle Width="80px" />
                        <ItemStyle HorizontalAlign="Right" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderStyle-Width="30px"
                        ...
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox ID="txtavailable" Style="width: 60px; text-align: right" onkeypress="return CheckNumeric(event)" runat="server" Text='<%#Eval("CreditQty") %>'></asp:TextBox>
                        </ItemTemplate>
