...
public partial class purchasedelete : System.Web.UI.Page
{
    int IDNo;
    ...
    protected void txtPurchase_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable dt = new DataTable();
            dt = Idv.Chetana.BAL.DCMaster.Get_Name(ECode, flag).Tables[0];
            if (dt.Rows.Count != 0)
            {
