<%@ Page Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="PrintJV.aspx.cs" Inherits="PrintJV" Title="PrintJV" %>
        ...
        <td>
             <asp:TextBox ID="txtfromDate" CssClass="inp-form" TabIndex="2" Width="80px" runat="server"
                ...
                <asp:RequiredFieldValidator ID="Rfvfdt" runat="server" ErrorMessage="Require From Date"
                    ValidationGroup="JVprint" ControlToValidate="txtfromDate">.</asp:RequiredFieldValidator>
        </td>
       <td width="30px"></td>
        <td width="60px">
        ...
        <td>
             <asp:TextBox ID="txttoDate" CssClass="inp-form" TabIndex="2" Width="80px" runat="server"
                ...
                <asp:RequiredFieldValidator ID="Rfvtdt" runat="server" ErrorMessage="Require To Date"
                    ValidationGroup="JVprint" ControlToValidate="txttoDate">.</asp:RequiredFieldValidator>
        </td>
    ...
    <td>
        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
            <ContentTemplate>
                ...
                ValidationGroup="JVprint" ControlToValidate="Txtdocno">.</asp:RequiredFieldValidator>
            </ContentTemplate>
        </asp:UpdatePanel>
    </td>
     <td width="30px"></td>
        <td>
             <asp:Button ID="btnget" runat="server" width="80px" Text="Get" CssClass="submitbtn" ValidationGroup="JVprint"
...
<br />
<br />
<cr:crystalreportviewer id="CrptJV" runat="server" 
            ...
            ShowAllPageIds="True" />
            <asp:ValidationSummary ShowMessageBox="true" ShowSummary="false" ValidationGroup="JVprint"
    runat="server" ID="ss" />
</div>
</asp:Content>
