...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
               ...
               <%-- <td width="120px">
                ...
                <td>
                    <asp:RadioButtonList ID="RdbtnSelect1" runat="server" RepeatDirection="Horizontal"
                        CssClass="lbl-form" Width="243px" OnSelectedIndexChanged="RdbtnSelect1_SelectedIndexChanged"
                        AutoPostBack="True">
                    ...
                    <td>
                     ...
                     <td>
                            <asp:Button ID="btnview" runat="server" Width="60px" Text="Get" ValidationGroup="Date"
                                TabIndex="6" CssClass="submitbtn" Style="height: 26px" OnClick="btnget1_Click" />
                        </td>
                     </tr>
                </table>
    ...
    <asp:Panel ID="Pnl13" runat="server" Visible="False">
        <div>
            <asp:Panel ID="Panel2" CssClass="panelDetails" runat="server" Width="660px">
                <table>
                    <tr>
                    <td>
                       <asp:DropDownList CssClass="ddl-form" ID="ddlSDZone" Width="250px" DataTextField="SDZoneName"
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Require Super Duper Zone "
                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <td>
                            <asp:Button ID="btnSummExcel" runat="server" Width="60px" Text="Get Data" ValidationGroup="Date"
                                TabIndex="6" CssClass="submitbtn" Style="height: 26px" 
                                 onclick="btnSummExcel_Click" />
                        </td>
    ...
    <p></p>
    <CR:CrystalReportViewer ID="CrOrderValuation" runat="server" PrintMode="ActiveX"
