<%@ Page Title="Purchase Delete" Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="purchasedelete.aspx.cs" Inherits="purchasedelete" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="section-header">
        <div class="title">
            ...
            Purchase Delete<a href="Campaigns.aspx" title="back to campaign list"></a>
        </div>
    </div>
    <div style="float: right; width: 53%">
        <asp:Button ID="btn_Save" CssClass="submitbtn" ValidationGroup="ct1" TabIndex="10"
            runat="server" Text="Delete" Width="87px" OnClick="btn_Save_Click" />
    </div>
    <br />
    <br />
    <asp:Panel ID="pnlpurch" CssClass="panelDetails" runat="server" Width="800px" Height="160px">
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtInvAlfa" ToolTip="text from invoice no." Width="50px" TabIndex="2" autocomplete="off" MaxLength="8"
                                runat="server" CssClass="inp-form"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDate" onblur="ValidInYearDate(this);" AutoComplete="off" Width="150px" CssClass="inp-form" TabIndex="3"
            ...
            <ContentTemplate>--%>
                ...
                <td>
                    <asp:Button ID="btnAdd" CssClass="submitbtn" ValidationGroup="ct" runat="server"
                        Text="Add" TabIndex="9" Width="80px" OnClick="btnAdd_Click" /></td>
                <%-- </ContentTemplate>
        </asp:UpdatePanel>--%>
            </tr>
            <tr>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Quantity" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                <ItemTemplate>
                    ...
                    <asp:TextBox ID="lblQuantity" Enabled="false" runat="server" Width="60px" onkeypress="return CheckNumeric(event)" Text='<%#Eval("Quantity") %>'></asp:TextBox>
                </ItemTemplate>
                <FooterTemplate>
            ...
            <asp:TemplateField HeaderText="Rate" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                <ItemTemplate>
                    <asp:TextBox ID="lblRate" Enabled="false" runat="server" Text='<%#Eval("Rate","{0:0.00}") %>' Width="50px" onkeypress="return CheckNumeric(event)"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Discount" ItemStyle-HorizontalAlign="Right">
                <ItemTemplate>
                    <asp:TextBox ID="lblDisc" Enabled="false" runat="server" Text='<%#Eval("Discount","{0:0.00}") %>' Width="50px"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                            <ContentTemplate>
                                                <asp:TextBox ID="TxtDocNo" onkeypress="return CheckNumeric(event)"
