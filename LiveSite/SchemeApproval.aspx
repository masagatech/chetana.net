<%@ Page Title="Scheme : Approval" Language="C#" MasterPageFile="~/MasterPages/NewChetana.master" AutoEventWireup="true" CodeFile="SchemeApproval.aspx.cs" Inherits="SchemeApproval" %>
 ...
 <div style="float: right; ">
        <div class="section-header">
            <div class="title">
                ...
                Scheme Approval<a href="Campaigns.aspx" title="back to campaign list"></a>
            </div>
        </div>
    </div>
    <div>
        <br />
        <br />
        <asp:Panel ID="pnlcust" runat="server" CssClass="panelDetails" Width="850px" Height="110px">
            <table>
        ...
        <CR:CrystalReportViewer ID="rptvSchemeApproval" runat="server" AutoDataBind="true"
            ...
            Height="1039px"  ShowAllPageIds="True" />
    </div>
</asp:Content>
