...
public partial class UserControls_CustomerWisePendingDC : System.Web.UI.Page
{
    #region Variables
    ...
    public void ShowDetails()
    {
         DataSet ds = new DataSet();
            ds = Idv.Chetana.BAL.DCMaster.Idv_Chetana_Customer_WisePendingDC(Convert.ToInt32(ddlCustmore.SelectedValue.ToString()), (txtFrom.Text.Split('/')[1] + "/" + txtFrom.Text.Split('/')[0] + "/" + txtFrom.Text.Split('/')[2]), (txtTo.Text.Split('/')[1] + "/" + txtTo.Text.Split('/')[0] + "/" + txtTo.Text.Split('/')[2]), Convert.ToInt32(strFY),
           Convert.ToInt32(DDLSuperZone.SelectedValue.ToString()), Convert.ToInt32(DDLZone.SelectedValue.ToString()),Convert.ToInt32(rdbselect.SelectedValue.ToString().Trim()));
            ...
            rd.Load(Server.MapPath("Report/CustomerWisePendingDc.rpt"));
            rd.Database.Tables[0].SetDataSource(dv);
            // rd.Database.Tables[1].SetDataSource(dv2);
            //rd.SetDataSource(ds);
            CustomerPendingDC.ReportSource = rd;
    }
